        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:52:13 */
        /* Location: ./modules/schedulercheck/controllers/ws_batpacka_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_batpacka_etc';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $dbFile='batpacka';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/PRDTRIAL/batpacka.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_batpacka_etc.bat%'"; 
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/ETERCON/DATA/PRDTRIAL/batpacka.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_VERSION '.$fk_1.' AND a.C_VERSION1 '.$fk_2.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_VERSION '.$fk_1.' AND C_VERSION1 '.$fk_2.'   AND iCompanyID= '.$selectCompany.' ' ;
