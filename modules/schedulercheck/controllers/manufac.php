        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-18 10:40:58 */
        /* Location: ./modules/schedulercheck/controllers/manufac.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='manufac';
               - $BackdateI='1';
               - $tbsql='dbf_conv.manufac';
               - $pk=odbc_result($rs,'c_faccode');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_faccode').' - '.odbc_result($rs,'c_facname');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='manufac';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PURCHASE/manufac.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/DATA/PURCHASE/manufac.dbf');
