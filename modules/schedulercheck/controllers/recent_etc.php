        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-25 10:41:46 */
        /* Location: ./modules/schedulercheck/controllers/recent_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='recent_etc';
               - $BackdateI='1';
               - $tbsql='sales.recent';
               - $pk=odbc_result($rs,'c_dnnumb');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_dnnumb').' - '.odbc_result($rs,'d_dndate');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='recent';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/emba/SALES/recent.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/DATA/emba/SALES/recent.dbf');
