        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 13:54:19 */
        /* Location: ./modules/menu/controllers/ws_currency_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_currency_etc';
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='ws_currency_etc';
               - $BackdateI='360';
               - $tbsql='purchase.currency';
               - $pk=odbc_result($rs,'c_currency');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_currency').' - '.odbc_result($rs,'c_currency');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='currency';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/PURCHASE/currency.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_currency_etc.bat%'"; 
            ...
            $db='purchase';
            $dbfFile = realpath('G:/ETERCON/DATA/PURCHASE/currency.dbf');
