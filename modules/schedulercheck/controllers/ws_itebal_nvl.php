        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:15:39 */
        /* Location: ./modules/schedulercheck/controllers/ws_itebal_nvl.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_itebal_nvl';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $dbFile='itebal';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/SALES/itebal.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_itebal_nvl.bat%'"; 
            ...
            $db='sales';
            $dbfFile = realpath('G:/DATA/SALES/itebal.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_BATCH '.$fk_1.' AND a.C_BATCH '.$fk_2.' AND a.C_LOT '.$fk_3.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_BATCH '.$fk_1.' AND C_BATCH '.$fk_2.' AND C_LOT '.$fk_3.'   AND iCompanyID= '.$selectCompany.' ' ;
