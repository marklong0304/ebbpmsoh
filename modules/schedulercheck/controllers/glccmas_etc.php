        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-24 14:53:32 */
        /* Location: ./modules/schedulercheck/controllers/glccmas_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='glccmas_etc';
               - $BackdateI='1';
               - $tbsql='umum.glccmas';
               - $pk=odbc_result($rs,'c_cccode');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_cccode').' - '.odbc_result($rs,'c_ccname');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='glccmas';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/gl/emba/glccmas.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/gl/emba/glccmas.dbf');
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
               ...
               if($last_update<>'-'){
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    //$pkv= $pk;
                    $pkv=odbc_result($rs,'c_cccode').' - '.odbc_result($rs,'c_ccname');
                    $pk2=odbc_result($rs,'c_tahun');
                   
                    /*cek data existing in mysql table*/
                    /*param use here*/

                    $sqlUdah = 'select * from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and c_tahun= "'.$pk2.'" ' ;
                    ...
                    if (!empty($rowUdah)) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '.$fPk.'  = "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and c_tahun= "'.$pk2.'"   ';
