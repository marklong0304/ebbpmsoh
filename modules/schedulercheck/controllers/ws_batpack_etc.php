        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:50:19 */
        /* Location: ./modules/schedulercheck/controllers/ws_batpack_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_batpack_etc';
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_batpack_etc.bat%'"; 
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/ETERCON/DATA/PRDTRIAL/batpack.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $pk=odbc_result($rs,'C_ITENO'); 
                    $fk_1=odbc_result($rs,'C_VERSION1');
                              if(trim($fk_1)==''){
                                              $fk_1 = ' is NULL';
                                            }else{
                                        ...
                                        $fk_2=odbc_result($rs,'C_VERSION1');
                              if(trim($fk_2)==''){
                                              $fk_2 = ' is NULL';
                                            }else{
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_VERSION1 '.$fk_1.' AND a.C_VERSION1 '.$fk_2.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_VERSION1 '.$fk_1.' AND C_VERSION1 '.$fk_2.'   AND iCompanyID= '.$selectCompany.' ' ;
