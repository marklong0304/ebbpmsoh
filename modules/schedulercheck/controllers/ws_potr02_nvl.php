        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:22:26 */
        /* Location: ./modules/menu/controllers/ws_potr02_nvl.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_potr02_nvl';
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='ws_potr02_nvl';
               - $BackdateI='360';
               - $tbsql='purchase.potr02';
               - $pk=odbc_result($rs,'C_PONUMB');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_PONUMB').' - '.odbc_result($rs,'C_PONUMB');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='potr02';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PURCHASE/potr02.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_potr02_nvl.bat%'"; 
            ...
            $db='purchase';
            $dbfFile = realpath('G:/DATA/PURCHASE/potr02.dbf');
