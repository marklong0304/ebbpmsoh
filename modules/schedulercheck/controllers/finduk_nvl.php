        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-10-05 09:49:22 */
        /* Location: ./modules/schedulercheck/controllers/finduk_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='finduk_nvl';
               - $BackdateI='360';
               - $tbsql='prdtrial.FINDUK';
               - $pk=odbc_result($rs,'c_iteno,c_urut');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_iteno,c_urut').' - '.odbc_result($rs,'c_iteno');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='FINDUK';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PRDTRIAL/FINDUK.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/DATA/PRDTRIAL/FINDUK.dbf');
