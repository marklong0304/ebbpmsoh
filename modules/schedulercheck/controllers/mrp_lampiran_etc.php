        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 12:06:29 */
        /* Location: ./modules/schedulercheck/controllers/mrp_lampiran_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='mrp_lampiran_etc';
               - $BackdateI='1';
               - $tbsql='MRP.lampiran';
               - $pk=odbc_result($rs,'c_lampcode');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_lampcode').' - '.odbc_result($rs,'c_lampcode');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='lampiran';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/mrp/lampiran.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/mrp/lampiran.dbf');
