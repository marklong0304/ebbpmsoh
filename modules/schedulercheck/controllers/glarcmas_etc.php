        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-24 10:55:27 */
        /* Location: ./modules/schedulercheck/controllers/glarcmas_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='glarcmas_etc';
               - $BackdateI='1';
               - $tbsql='umum.glarcmas';
               - $pk=odbc_result($rs,'c_tahun');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_tahun').' - '.odbc_result($rs,'c_tahun');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='glarcmas';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/gl/emba//glarcmas.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/gl/emba//glarcmas.dbf');
            $dbfDir = dirname($dbfFile);
            $dbfDir1 = 'G:/data/emba/gl/emba/';
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
               ...
               if($last_update<>'-'){
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select * from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and a.c_comco= "'.$pk2.'" ' ;
                    ...
                    if (!empty($rowUdah)) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '.$fPk.'  = "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and a.c_comco= "'.$pk2.'"';
