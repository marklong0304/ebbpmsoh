        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 15:31:29 */
        /* Location: ./modules/schedulercheck/controllers/ws_roomline_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_roomline_etc';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $BackdateI='360';
               - $tbsql='mrp.roomline';
               - $pk=odbc_result($rs,'C_ROOMCODE');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_ROOMCODE').' - '.odbc_result($rs,'C_ROOMCODE');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='roomline';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/MRP/roomline.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_roomline_etc.bat%'"; 
            ...
            $db='mrp';
            $dbfFile = realpath('G:/ETERCON/DATA/MRP/roomline.dbf');
