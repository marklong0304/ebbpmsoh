        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-03-20 09:31:14 */
        /* Location: ./modules/schedulercheck/controllers/imsd_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='imsd_nvl';
               - $BackdateI='1';
               - $tbsql='purchase.IMSD';
               - $pk=odbc_result($rs,'Batchno');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'Batchno').' - '.odbc_result($rs,'Itemnumb');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='IMSD';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PURCHASE/IMSD.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/DATA/PURCHASE/IMSD.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select * from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"' ;
