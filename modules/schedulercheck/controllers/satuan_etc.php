        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 11:37:41 */
        /* Location: ./modules/schedulercheck/controllers/satuan_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='satuan_etc';
               - $BackdateI='1';
               - $tbsql='MRP.satuan';
               - $pk=odbc_result($rs,'c_satuan');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_satuan').' - '.odbc_result($rs,'c_satuan');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='satuan';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/mrp/satuan.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/mrp/satuan.dbf');
