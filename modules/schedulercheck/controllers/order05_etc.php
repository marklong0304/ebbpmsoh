        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-24 10:44:24 */
        /* Location: ./modules/schedulercheck/controllers/order05_etc.php */
        ...
        /*
         ...
         3. Parameter 
               ...
               - $dbFile='order05';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/purchase/order05.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/purchase/order05.dbf');
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
               ...
               if($last_update<>'-'){
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $pk2=odbc_result($rs,'c_itemnumb');
                    
                   
                    /*cek data existing in mysql table*/
                    /*param use here*/

                    $sqlUdah = 'select * from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and a.c_itemnumb= "'.$pk2.'" ' ;
                    ...
                    if (!empty($rowUdah)) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '.$fPk.'  = "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and a.c_itemnumb= "'.$pk2.'"    ';
