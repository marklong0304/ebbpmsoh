        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-09-15 10:46:09 */
        /* Location: ./modules/schedulercheck/controllers/mr02.php */
        ...
        /*
         ...
         3. Parameter 
               ...
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_ITEMNUMB').' - '.odbc_result($rs,'C_BATCHNO');
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
               ...
               if($last_update<>'-'){
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $pk2=odbc_result($rs,'C_BATCHNO');
                    $fPk2='C_BATCHNO';

                    $pk3=odbc_result($rs,'C_MRNO');
                    $fPk3='C_MRNO';
                    ...
                    $sqlUdah = 'select * from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  AND a.'.$fPk2.'= "'.$pk2.'" AND a.'.$fPk3.'= "'.$pk3.'"' ;
                    ...
                    if (!empty($rowUdah)) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '.$fPk.'  = "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  AND a.'.$fPk2.'= "'.$pk2.'" AND a.'.$fPk3.'= "'.$pk3.'"   ';
