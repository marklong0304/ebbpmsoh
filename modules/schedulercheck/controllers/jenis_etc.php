        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-22 15:40:56 */
        /* Location: ./modules/schedulercheck/controllers/jenis_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='jenis_etc';
               - $BackdateI='1';
               - $tbsql='sales.jenis';
               - $pk=odbc_result($rs,'c_jen is');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_jen is').' - '.odbc_result($rs,'c_nmjenis');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='jenis';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/sales/jenis.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/sales/jenis.dbf');
