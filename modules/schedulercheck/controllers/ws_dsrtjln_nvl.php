        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:13:34 */
        /* Location: ./modules/schedulercheck/controllers/ws_dsrtjln_nvl.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_dsrtjln_nvl';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $BackdateI='360';
               - $tbsql='sales.dsrtjln';
               - $pk=odbc_result($rs,'C_NOSRT');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_NOSRT').' - '.odbc_result($rs,'C_NOSRT');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='dsrtjln';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/SALES/dsrtjln.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_dsrtjln_nvl.bat%'"; 
            ...
            $db='sales';
            $dbfFile = realpath('G:/DATA/SALES/dsrtjln.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_INVNO '.$fk_1.' AND a.C_INVNO '.$fk_2.' AND a.C_ITENO '.$fk_3.' AND a.C_PANUMB '.$fk_4.' AND a.C_LOT '.$fk_5.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_INVNO '.$fk_1.' AND C_INVNO '.$fk_2.' AND C_ITENO '.$fk_3.' AND C_PANUMB '.$fk_4.' AND C_LOT '.$fk_5.'   AND iCompanyID= '.$selectCompany.' ' ;
