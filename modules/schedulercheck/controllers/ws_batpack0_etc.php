        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:51:31 */
        /* Location: ./modules/schedulercheck/controllers/ws_batpack0_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_batpack0_etc';
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_batpack0_etc.bat%'"; 
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/ETERCON/DATA/PRDTRIAL/batpack0.dbf');
            $dbfDir = dirname($dbfFile);
            $dbfDir1 = 'G:/ETERCON/DATA/PRDTRIAL';
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_VERSION '.$fk_1.' AND a.C_VERSION '.$fk_2.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_VERSION '.$fk_1.' AND C_VERSION '.$fk_2.'   AND iCompanyID= '.$selectCompany.' ' ;
