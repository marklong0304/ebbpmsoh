        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-22 18:36:59 */
        /* Location: ./modules/schedulercheck/controllers/tabgr_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='tabgr_etc';
               - $BackdateI='1';
               - $tbsql='sales.tabgr';
               - $pk=odbc_result($rs,'c_group');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_group').' - '.odbc_result($rs,'c_desc');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='tabgr';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/sales/tabgr.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/sales/tabgr.dbf');
