        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:26:32 */
        /* Location: ./modules/menu/controllers/ws_manufac_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_manufac_etc';
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='ws_manufac_etc';
               - $BackdateI='360';
               - $tbsql='purchase.manufac';
               - $pk=odbc_result($rs,'C_FACCODE');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_FACCODE').' - '.odbc_result($rs,'C_FACCODE');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='manufac';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/PURCHASE/manufac.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_manufac_etc.bat%'"; 
            ...
            $db='purchase';
            $dbfFile = realpath('G:/ETERCON/DATA/PURCHASE/manufac.dbf');
