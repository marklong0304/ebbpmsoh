        ...
        /* Location: ./modules/menu/controllers/itemas_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='itemas_etc';
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='sales';
            $dbfFile = realpath('G:/ETERCON/DATA/SALES/ITEMAS.dbf');
            ...
            $conn_db = odbc_connect('Driver={Microsoft Visual FoxPro Driver};SourceType=DBF;SourceDB='.$dbfDir1.';Exclusive=No;Collate=Machine;NULL=NO;DELETED=YES;BACKGROUNDFETCH=NO;' , '', '');
             ...
             if (!$conn_db)
             {
                SendToSyslog('sch_'.$scheduler_name,'Failed Connect Data DBF : '.$conn_db);
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $sa = '';
                      echo 'Updating ... '.$scheduler_name.'  '.$pk;
                      $sa.='UPDATE '.$tbsql.' SET ';
                      $i=0;
                       ...
                       $sa = '';
                       echo 'Inserting ... '.$scheduler_name.'  '.$pk;
