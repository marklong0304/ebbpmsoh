        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:21:14 */
        /* Location: ./modules/schedulercheck/controllers/ws_corent02_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_corent02_etc';
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='ws_corent02_etc';
               - $BackdateI='360';
               - $tbsql='sales.corent02';
               - $pk=odbc_result($rs,'C_CORNO');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_CORNO').' - '.odbc_result($rs,'C_CORNO');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='corent02';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/SALES/corent02.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_corent02_etc.bat%'"; 
            ...
            $db='sales';
            $dbfFile = realpath('G:/ETERCON/DATA/SALES/corent02.dbf');
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_ITENO '.$fk_1.'   AND iCompanyID= '.$selectCompany.' ' ;
