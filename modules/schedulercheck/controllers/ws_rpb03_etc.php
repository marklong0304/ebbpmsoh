        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 15:29:32 */
        /* Location: ./modules/schedulercheck/controllers/ws_rpb03_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_rpb03_etc';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $BackdateI='360';
               - $tbsql='mrp.rpb03';
               - $pk=odbc_result($rs,'C_PERIOD');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_PERIOD').' - '.odbc_result($rs,'C_PERIOD');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='rpb03';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/MRP/rpb03.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_rpb03_etc.bat%'"; 
            ...
            $db='mrp';
            $dbfFile = realpath('G:/ETERCON/DATA/MRP/rpb03.dbf');
            $dbfDir = dirname($dbfFile);
            $dbfDir1 = 'G:/ETERCON/DATA/MRP';
