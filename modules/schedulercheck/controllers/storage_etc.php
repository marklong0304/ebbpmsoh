        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-22 15:07:36 */
        /* Location: ./modules/schedulercheck/controllers/storage_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='storage_etc';
               - $BackdateI='1';
               - $tbsql='purchase.storage';
               - $pk=odbc_result($rs,'n_stonumb');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'n_stonumb').' - '.odbc_result($rs,'c_stoname');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='storage';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/purchase/storage.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/purchase/storage.dbf');
            $dbfDir = dirname($dbfFile);
            $dbfDir1 = 'G:/data/emba/purchase';
