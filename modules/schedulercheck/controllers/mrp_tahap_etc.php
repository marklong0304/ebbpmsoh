        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 12:08:31 */
        /* Location: ./modules/schedulercheck/controllers/mrp_tahap_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='mrp_tahap_etc';
               - $BackdateI='1';
               - $tbsql='MRP.tahap';
               - $pk=odbc_result($rs,'c_tahap');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_tahap').' - '.odbc_result($rs,'c_tahap');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='tahap';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/mrp/tahap.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/mrp/tahap.dbf');
