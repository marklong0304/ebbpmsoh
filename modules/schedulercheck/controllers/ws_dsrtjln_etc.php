        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:30:07 */
        /* Location: ./modules/schedulercheck/controllers/ws_dsrtjln_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_dsrtjln_etc';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $dbFile='dsrtjln';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/SALES/dsrtjln.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_dsrtjln_etc.bat%'"; 
            ...
            $db='sales';
            $dbfFile = realpath('G:/ETERCON/DATA/SALES/dsrtjln.dbf');
            $dbfDir = dirname($dbfFile);
            $dbfDir1 = 'G:/ETERCON/DATA/SALES';
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_INVNO '.$fk_1.' AND a.C_ITENO '.$fk_2.' AND a.C_PANUMB '.$fk_3.' AND a.C_LOT '.$fk_4.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_INVNO '.$fk_1.' AND C_ITENO '.$fk_2.' AND C_PANUMB '.$fk_3.' AND C_LOT '.$fk_4.'   AND iCompanyID= '.$selectCompany.' ' ;
