        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-22 10:03:16 */
        /* Location: ./modules/schedulercheck/controllers/trial_imsh.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='trial_imsh';
               - $BackdateI='1';
               - $tbsql='purchase.imsh';
               - $pk=odbc_result($rs,'c_itemnumb');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_itemnumb').' - '.odbc_result($rs,'c_itemname');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='imsh';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/purchase/imsh.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/purchase/imsh.dbf');
