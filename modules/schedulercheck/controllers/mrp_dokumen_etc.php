        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 12:05:48 */
        /* Location: ./modules/schedulercheck/controllers/mrp_dokumen_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='mrp_dokumen_etc';
               - $BackdateI='1';
               - $tbsql='MRP.dokumen';
               - $pk=odbc_result($rs,'c_no');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_no').' - '.odbc_result($rs,'c_no');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='dokumen';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/mrp/dokumen.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/mrp/dokumen.dbf');
