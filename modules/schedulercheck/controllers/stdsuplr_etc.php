        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-24 10:23:34 */
        /* Location: ./modules/schedulercheck/controllers/stdsuplr_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='stdsuplr_etc';
               - $BackdateI='1';
               - $tbsql='purchase.stdsuplr';
               - $pk=odbc_result($rs,'c_itemnumb');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_itemnumb').' - '.odbc_result($rs,'c_itemnumb');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='stdsuplr';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/purchase/stdsuplr.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/purchase/stdsuplr.dbf');
