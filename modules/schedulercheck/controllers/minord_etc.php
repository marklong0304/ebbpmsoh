        ...
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-24 10:52:37 */
        /* Location: ./modules/schedulercheck/controllers/minord_etc.php */
        ...
        /*
         ...
         3. Parameter 
               ...
               - $dbFile='minord';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/purchase/minord.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/purchase/minord.dbf');
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
               ...
               if($last_update<>'-'){
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    //$pkv= $pk;
                    $pkv=odbc_result($rs,'c_itemnumb').' - '.odbc_result($rs,'c_itemnumb');
                    $pk2=odbc_result($rs,'c_faccode');
                    $pk3=odbc_result($rs,'c_supnumb');
                    ...
                    $sqlUdah = 'select * from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and a.c_faccode= "'.$pk2.'" and a.c_supnumb= "'.$pk3.'"' ;
                    ...
                    if (!empty($rowUdah)) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '.$fPk.'  = "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and a.c_faccode= "'.$pk2.'" and a.c_supnumb= "'.$pk3.'"   ';
