        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:02:58 */
        /* Location: ./modules/schedulercheck/controllers/ws_arebal_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_arebal_etc';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $BackdateI='360';
               - $tbsql='sales.arebal';
               - $pk=odbc_result($rs,'C_INVNO');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_INVNO').' - '.odbc_result($rs,'C_INVNO');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='arebal';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/SALES/arebal.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_arebal_etc.bat%'"; 
            ...
            $db='sales';
            $dbfFile = realpath('G:/ETERCON/DATA/SALES/arebal.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_ITENO '.$fk_1.' AND a.C_ITENO '.$fk_2.' AND a.C_IBANO '.$fk_3.' AND a.C_LOT '.$fk_4.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_ITENO '.$fk_1.' AND C_ITENO '.$fk_2.' AND C_IBANO '.$fk_3.' AND C_LOT '.$fk_4.'   AND iCompanyID= '.$selectCompany.' ' ;
