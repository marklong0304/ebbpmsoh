        ...
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-10-05 14:37:59 */
        /* Location: ./modules/schedulercheck/controllers/aprvmail_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='aprvmail_nvl';
               - $BackdateI='360';
               - $tbsql='prdtrial.APRVMAIL';
               - $pk=odbc_result($rs,'C_ITENO');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_ITENO').' - '.odbc_result($rs,'-');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='APRVMAIL';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PRDTRIAL/APRVMAIL.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/DATA/PRDTRIAL/APRVMAIL.dbf');
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select * from '.$tbsql.' a where a.iCompanyID= '.$selectCompany.'  
                                  AND a.'.$fPk.'= "'.$pk.'"  AND a.C_USERID="'.$fk_1.'" ' ;
                    ...
                    if (!empty($rowUdah)) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where " '  .$fPk. ' "  = " '  .$pk. ' "     AND a.C_USERID="'.$fk_1.'"   ';
