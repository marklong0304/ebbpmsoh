        ...
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-10-17 13:46:11 */
        /* Location: ./modules/schedulercheck/controllers/arebal_nvl.php */
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select * from '.$tbsql.' a where a.iCompanyID= '.$selectCompany.'  
                                  AND a.'.$fPk.'= "'.$pk.'"  AND a.C_iteno="'.$fk_1.'" AND a.C_ibano="'.$fk_2.'" AND a.C_lot="'.$fk_3.'" ' ;
                    ...
                    if (!empty($rowUdah)) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '.$fPk.'  = "'.$pk.'"     AND C_iteno="'.$fk_1.'" AND C_ibano="'.$fk_2.'" AND C_lot="'.$fk_3.'"   ';
