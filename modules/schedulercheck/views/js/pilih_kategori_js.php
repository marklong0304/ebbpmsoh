<!-- 
    #parameter 
    1. pilih_kategori
    2. processor/complaint/pilih/kategori
            ...
            if(isUpload && !isValidAFileSize('#form_create_'+grid+' input.multifile', uploadLimit)) {
                ...
                $.ajax({
                    ...
                    success: function(data) {   
                        ...
                        if(o.status == true) {
                            if(isUpload) {
                                var iframe = $('<iframe name="pilih_kategori_frame"/>');
                                iframe.attr({'id':'pilih_kategori_frame'});
                                ...
                                $('#form_create_'+grid).attr('target','pilih_kategori_frame');                              
                            ...
                            $.get(base_url+'processor/complaint/pilih/kategori?action=update&foreign_key=0&company_id='+company_id+'&id='+last_id+'&group_id='+group_id+'&modul_id='+modul_id, function(data) {
                    ...
                    success: function(data) {   
                        ...
                        if(o.status == true) {
                            if(isUpload) {
                                ...
                                uploadfile('form_create_'+grid, grid, formAction, base_url+'processor/complaint/pilih/kategori?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);                             

                                //ppic_memo_busdev_tryUPload('form_create'+grid , grid, formAction, base_url+'processor/complaint/pilih/kategori?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
                            
                            }else{
                                _custom_alert('Data Berhasil Disimpan !',header,info, grid, 1, 20000);
                                $.get(base_url+'processor/complaint/pilih/kategori?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
                                    $('div#form_'+grid).html(data);
                                    $('html, body').animate({scrollTop:$('#'+grid).offset().top - 20}, 'slow');
                                });
                            }
                    ...
                    var modul_id = o.modul_id;
                        if(o.status == true){
                            if(isUpload) {
                                ...
                                //ppic_memo_busdev_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/complaint/pilih/kategori?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
            ...
            //if(!isUpload) {
                ...
                success: function(data) {
                    ...
                    if(isUpload) {
                        ...
                        $('#form_update_'+grid).attr('target','pilih_kategori_frame');                              
                ...
                success: function(data) {
                    ...
                    if(o.status == true){
                        if(isUpload) {
                            ...
                            uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/complaint/pilih/kategori?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
                            //ppic_memo_busdev_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/complaint/pilih/kategori?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );
            ...
            //if(!isUpload) {
                ...
                .done(function(data) {
                    ...
                    $('#grid_'+grid).trigger('reloadGrid');
                        ...
                        $.get(base_url+'processor/complaint/pilih/kategori?action=update&id='+last_id+'&foreign_key='+foreign_id+'&company_id='+company_id+'&group_id='+group_id+'&modul_id='+modul_id, function(data) {
                                $('div#form_'+grid).html(data);
                                $('html, body').animate({scrollTop:$('#'+grid).offset().top - 20}, 'slow');
                        });
                });
...
<iframe name="pilih_kategori_frame" id="pilih_kategori_frame" height="0" width="0"></iframe>
