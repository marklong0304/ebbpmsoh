			...
			?>
							<tr>
								...
								<td style="text-align: center">
									<input class="vName_member_div_cNip" value="<?php echo $v['vnip']; ?>" name="nip[]" type="hidden" >
									<input value="<?php echo $v['vName']; ?> - <?php echo $v['vnip']; ?>" class="input_rows-table vName_member_div" style="width: 98%" name="name[]" type="text" >
								</td>
