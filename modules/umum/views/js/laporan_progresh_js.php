                ...
                success: function(data) {
                    ...
                    if(o.status == true){
                        if(isUpload) {
                            ...
                            var iframe = $('<iframe name="laporan_progresh_frame"/>');
                            iframe.attr({'id':'laporan_progresh_frame'});
                            ...
                            $('#form_update_'+grid).attr('target','laporan_progresh_frame');

                            uploadfile('form_update_'+grid, grid, formAction, base_url+'processor/complaint/laporan_progresh?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id);
                            //laporan_progresh_tryUPload('form_update_'+grid , grid, formAction, base_url+'processor/complaint/laporan_progresh?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id );

                            }else{
                            _custom_alert('Data Berhasil Disimpan!',header,info, grid, 1, 20000);
                            $.get(base_url+'processor/complaint/laporan_progresh?action=update&id='+o.last_id+'&foreign_key='+o.foreign_id+'&company_id='+o.company_id+'&group_id='+o.group_id+'&modul_id='+o.modul_id, function(data) {
...
<iframe name="laporan_progresh_frame" id="laporan_progresh_frame" height="0" width="0"></iframe>
