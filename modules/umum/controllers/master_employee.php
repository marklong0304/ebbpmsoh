...
*/
    ...
    //set search
        $grid->setSearch('cNip','vName','vEmail','vAddress','vTelepon','vEmail_company','vName_company','vAddress_company','vTelepon_company','vFax_company','iCompanyID','iDivisionID','iDepartementID','iPostID','vPassword','lDeleted','cCreated','dCreated','cUpdated','dUpdated');
    ...
    */
    ...
    function manipulate_insert_button($buttons, $rowData) { 
        ...
        $save_draft = '<button onclick="javascript:save_draft_btn_multiupload(\'master_employee\', \' '.base_url().'processor/folder_app/master_employee?draft=true \',this,true )"  id="button_save_draft_master_employee"  class="ui-button-text icon-save" >Save as Draft</button>';
        $save = '<button onclick="javascript:save_btn_multiupload(\'master_employee\', \' '.base_url().'processor/folder_app/master_employee?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'modul_id='.$this->input->get('modul_id').' \',this,true )"  id="button_save_submit_master_employee"  class="ui-button-text icon-save" >Save &amp; Submit</button>';
    ...
    function manipulate_update_button($buttons, $rowData) { 
        ...
        $update_draft = '<button onclick="javascript:update_draft_btn(\'master_employee\', \' '.base_url().'processor/folder_app/master_employee?draft=true \',this,true )"  id="button_update_draft_master_employee"  class="ui-button-text icon-save" >Update as Draft</button>';
        $update = '<button onclick="javascript:update_btn_back(\'master_employee\', \' '.base_url().'processor/folder_app/master_employee?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'modul_id='.$this->input->get('modul_id').' \',this,true )"  id="button_update_submit_master_employee"  class="ui-button-text icon-save" >Update &amp; Submit</button>';

        $approve = '<button onclick="javascript:load_popup(\' '.base_url().'processor/folder_app/master_employee?action=approve&ID='.$peka.'&company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').' \')"  id="button_approve_master_employee"  class="ui-button-text icon-save" >Approve</button>';
        $reject = '<button onclick="javascript:load_popup(\' '.base_url().'processor/folder_app/master_employee?action=reject&ID='.$peka.'&company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').' \' )"  id="button_reject_master_employee"  class="ui-button-text icon-save" >Reject</button>';
