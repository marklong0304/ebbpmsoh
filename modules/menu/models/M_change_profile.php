...
class M_change_profile extends CI_Model{
	public $table;
	public $db;
	...
	function getEmployeeProfile($nip){
		...
		try{
			$sql 	= "SELECT a.cNip AS NIP, a.vName AS Nama, b.vDescription AS Divisi, c.vDescription AS Departemen, d.vDescription AS Posisi, 
											e.vCompName AS Perusahaan, e2.vAreaName AS Area_Kerja,  a.vEmail AS EmailKantor, substr(a.vhp, 1 , 2) AS HandPhone0, substr(a.vhp, 3) AS HandPhone ,
