...
<?php
/* Generated by Softdev 2 ERP Module Generator 2019-02-03 21:55:28 */
/* Location: ./modules/pengujian/controllers/mt02.php */
...
class mt02 extends MX_Controller {
    ...
    function index($action = '') {
        ...
        $grid = new Grid;
        $grid->setTitle('MT02');
        $grid->setTable('bbpmsoh.mt02');      
        $grid->setUrl('mt02');

        //List Table
        $grid->addList('iMt01','dTgl_Kontrak','p1_nama','p1_perusahaan','p1_an','iSubmit','iApprove'); 
        $grid->setSortBy('iMt02');
        $grid->setSortOrder('DESC');  

        //List field
        $grid->addFields('iSubmit','iApprove','iMt01','dTgl_Kontrak','p1_nama','p1_jabatan','p1_perusahaan','p1_alamat','p1_an','p2_nama','p2_jabatan','vNama_sample','vAcuan_metode_uji','vKeterangan'); 
        ...
        */
        ...
        $grid->setAlign('iMt01', 'center');
        $grid->setLabel('iMt01','No MT01');


        $grid->setWidth('dTgl_Kontrak', '100');
        $grid->setAlign('dTgl_Kontrak', 'left');
        $grid->setLabel('dTgl_Kontrak','Tanggal Kontrak');
    
        $grid->setWidth('p1_nama', '250');
        $grid->setAlign('p1_nama', 'left');
        $grid->setLabel('p1_nama','Nama');
    
        $grid->setWidth('p1_jabatan', '200');
        $grid->setAlign('p1_jabatan', 'left');
        $grid->setLabel('p1_jabatan','Jabatan');
    
        $grid->setWidth('p1_perusahaan', '200');
        $grid->setAlign('p1_perusahaan', 'left');
        $grid->setLabel('p1_perusahaan','Perusahaan');
    
        $grid->setWidth('p1_alamat', '200');
        $grid->setAlign('p1_alamat', 'left');
        $grid->setLabel('p1_alamat','Alamat');
    
        $grid->setWidth('p1_an', '200');
        $grid->setAlign('p1_an', 'left');
        $grid->setLabel('p1_an','Pihak Pertama ( Customer )');
    
        $grid->setWidth('p2_nama', '100');
        $grid->setAlign('p2_nama', 'left');
        $grid->setLabel('p2_nama','Nama');
    
        $grid->setWidth('p2_jabatan', '100');
        $grid->setAlign('p2_jabatan', 'left');
        $grid->setLabel('p2_jabatan','Jabatan');
    
        $grid->setWidth('vNama_sample', '100');
        $grid->setAlign('vNama_sample', 'left');
        $grid->setLabel('vNama_sample','Nama Sample');
    
        $grid->setWidth('vAcuan_metode_uji', '100');
        $grid->setAlign('vAcuan_metode_uji', 'left');
        $grid->setLabel('vAcuan_metode_uji','Acuan Metoda Uji');
    
        $grid->setWidth('vKeterangan', '100');
...
*/
    ...
    //set search
        $grid->setSearch('iMt01','dTgl_Kontrak','p1_nama','p1_perusahaan','p1_an','iSubmit','iApprove');
        
    //set required
        $grid->setRequired('iMt01','dTgl_Kontrak','p1_nama','p1_jabatan','p1_perusahaan','p1_alamat','p1_an','p2_nama','p2_jabatan','vNama_sample','vAcuan_metode_uji','vKeterangan','iSubmit','iApprove','dApprove','cApprove','vRemark','cCreated','dCreated','cUpdated','dUpdated','lDeleted'); 
    ...
    */
                        ...
                        function insertBox_mt02_p1_jabatan($field, $id) {
                            $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30"  />';
                            return $return;
                        }
                        
                        function updateBox_mt02_p1_jabatan($field, $id, $value, $rowData) {
                                if ($this->input->get('action') == 'view') {
                                     $return= $value; 
                                }else{ 
                                    $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1  required" size="30" value="'.$value.'"/>';
                        ...
                        function insertBox_mt02_p1_an($field, $id) {
                            $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30"  />';
                            return $return;
                        }
                        
                        function updateBox_mt02_p1_an($field, $id, $value, $rowData) {
                                if ($this->input->get('action') == 'view') {
                                     $return= $value; 
                                }else{ 
                                    $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1  required" size="30" value="'.$value.'"/>';
                        ...
                        function insertBox_mt02_p2_nama($field, $id) {
                            $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30"  />';
                            return $return;
                        }
                        
                        function updateBox_mt02_p2_nama($field, $id, $value, $rowData) {
                                if ($this->input->get('action') == 'view') {
                                     $return= $value; 
                                }else{ 
                                    $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1  required" size="30" value="'.$value.'"/>';
                        ...
                        function insertBox_mt02_p2_jabatan($field, $id) {
                            $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 required" size="30"  />';
                            return $return;
                        }
                        
                        function updateBox_mt02_p2_jabatan($field, $id, $value, $rowData) {
                                if ($this->input->get('action') == 'view') {
                                     $return= $value; 
                                }else{ 
                                    $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1  required" size="30" value="'.$value.'"/>';
                        ...
                        function insertBox_mt02_vKeterangan($field, $id) {
                            $return = '<textarea name="'.$field.'" id="'.$id.'" class="required" style="width: 240px; height: 75px;" size="250" maxlength ="250"></textarea>';
                            return $return;
                        }
                        
                        function updateBox_mt02_vKeterangan($field, $id, $value, $rowData) {
                                if ($this->input->get('action') == 'view') {
                                     $return= '<label title="Note">'.nl2br($value).'</label>'; 
                                }else{ 
                                    $return = '<textarea name="'.$field.'" id="'.$id.'" class="required" style="width: 240px; height: 75px;" size="250" maxlength ="250">'.nl2br($value).'</textarea>';
                        ...
                        function insertBox_mt02_iSubmit($field, $id) {
                            $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 angka required" size="10" />';
                            return $return;
                        }
                        
                        function updateBox_mt02_iSubmit($field, $id, $value, $rowData) {
                                if ($this->input->get('action') == 'view') {
                                     $return= $value; 
                                }else{ 
                        ...
                        function insertBox_mt02_iApprove($field, $id) {
                            $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 angka required" size="10" />';
                            $return .= '<input type="hidden" name="isdraft"   class="input_rows1 " size="30"  />';
                            return $return;
                        }
                        
                        function updateBox_mt02_iApprove($field, $id, $value, $rowData) {
                                if ($this->input->get('action') == 'view') {
                                     $return= $value; 
                                }else{ 
                                    $return = '<input type="text" name="'.$field.'"  id="'.$id.'"  class="input_rows1 angka required" size="10" value="'.$value.'"/>';
    ...
    /*
        ...
        function approve_view() {
            ...
            $echo .= 'Remark : 
                    <input type="hidden" name="iMt02" value="'.$this->input->get('iMt02').'" />
    ...
    /*
        ...
        function reject_view() {
            ...
            $echo .= 'Remark : 
                    ...
                    <textarea name="vRemark" id="reject_mt02_remark"></textarea>
    ...
    */
    ...
    function manipulate_insert_button($buttons) { 
        ...
        $iframe = '<iframe name="mt02_frame" id="mt02_frame" height="0" width="0"></iframe>';
        
        $save_draft = '<button onclick="javascript:save_draft_btn_multiupload(\'mt02\', \' '.base_url().'processor/pengujian/mt02?draft=true \',this,true )"  id="button_save_draft_mt02"  class="ui-button-text icon-save" >Save as Draft</button>';
        $save = '<button onclick="javascript:save_btn_multiupload(\'mt02\', \' '.base_url().'processor/pengujian/mt02?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'modul_id='.$this->input->get('modul_id').' \',this,true )"  id="button_save_submit_mt02"  class="ui-button-text icon-save" >Save &amp; Submit</button>';
    ...
    function manipulate_update_button($buttons, $rowData) { 
        ...
        $update_draft = '<button onclick="javascript:update_draft_btn(\'mt02\', \' '.base_url().'processor/pengujian/mt02?draft=true \',this,true )"  id="button_update_draft_mt02"  class="ui-button-text icon-save" >Update as Draft</button>';
        $update = '<button onclick="javascript:update_btn_back(\'mt02\', \' '.base_url().'processor/pengujian/mt02?company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'modul_id='.$this->input->get('modul_id').' \',this,true )"  id="button_update_submit_mt02"  class="ui-button-text icon-save" >Update &amp; Submit</button>';

        $approve = '<button onclick="javascript:load_popup(\' '.base_url().'processor/pengujian/mt02?action=approve&iMt02='.$peka.'&company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').' \')"  id="button_approve_mt02"  class="ui-button-text icon-save" >Approve</button>';
        $reject = '<button onclick="javascript:load_popup(\' '.base_url().'processor/pengujian/mt02?action=reject&iMt02='.$peka.'&company_id='.$this->input->get('company_id').'&group_id='.$this->input->get('group_id').'&modul_id='.$this->input->get('modul_id').' \' )"  id="button_reject_mt02"  class="ui-button-text icon-save" >Reject</button>';
