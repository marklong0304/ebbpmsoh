	...
	<tbody>
		...
		?>	
				<!-- fisik -->
					...
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" value="<?php echo $row['vHomogen'] ?>" name="vHomogen" value="" class="vHomogen required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vHomogen']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" value="<?php echo $row['vHomogen_metoda'] ?>" name="vHomogen_metoda" value="" class="vHomogen_metoda required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vHomogen_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" value="<?php echo $row['vHomogen_mutu'] ?>" name="vHomogen_mutu" value="" class="vHomogen_mutu required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vHomogen_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
				...
				<!-- kevakuman -->
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" value="<?php echo $row['vVakum'] ?>" name="vVakum" class="vVakum required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vVakum']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" value="<?php echo $row['vVakum_metoda'] ?>" name="vVakum_metoda"class="vVakum_metoda required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vVakum_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" value="<?php echo $row['vVakum_mutu'] ?>" name="vVakum_mutu"  class="vVakum_mutu required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vVakum_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
						...
						<td style="border: 1px solid #dddddd; width: 10%; text-align: left;">
							<table style="width: 100%; text-align: left;">
								<tr>
									...
									<td>:
										<textarea type="text" value="<?php echo $row['vMurni_apus'] ?>" name="vMurni_apus"  class="vMurni required" style="width: 85%; text-align: left;"><?php echo nl2br($row['vMurni_apus']) ?></textarea>
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: left;">37 &deg C</td>
									<td>:
										<textarea type="text" value="<?php echo $row['vMurni_37'] ?>" name="vMurni_37"  class="vMurni required" style="width: 85%; text-align: left;"><?php echo nl2br($row['vMurni_37']) ?></textarea>
									</td>
								</tr>
							</table>
						</td>
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vMurni_metoda" value="<?php echo $row['vMurni_metoda'] ?>" class="vMurni_metoda required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vMurni_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vMurni_mutu"value="<?php echo $row['vMurni_mutu'] ?>" class="vMurni_mutu required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vMurni_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
						...
						<td style="border: 1px solid #dddddd; width: 10%; text-align: left;">
							<table style="width: 95%; text-align: left;">
								<tr>
									<td style="width: 30%; text-align: left;">37 &deg C</td>
									<td>:
										<textarea type="text" name="vSteril_37" value="<?php echo $row['vSteril_37'] ?>" class="vSteril required" style="width: 85%; text-align: left;"><?php echo nl2br($row['vSteril_37']) ?></textarea>
									</td>
								</tr>
								<tr>
									<td>22 &deg C</td>
									<td>:
										<textarea type="text" name="vSteril_22" value="<?php echo $row['vSteril_22'] ?>" class="vSteril required" style="width: 85%; text-align: left;"><?php echo nl2br($row['vSteril_22']) ?></textarea>
									</td>
								</tr>
							</table>
						</td>
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vSteril_metoda" value="<?php echo $row['vSteril_metoda'] ?>" class="vSteril_metoda required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vSteril_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vSteril_mutu" value="<?php echo $row['vSteril_mutu'] ?>" class="vSteril_mutu required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vSteril_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
				...
				<!-- disolasi -->
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" name="vDisolasi" value="<?php echo $row['vDisolasi'] ?>" class="vDisolasi required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vDisolasi']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vDisolasi_metoda" value="<?php echo $row['vDisolasi_metoda'] ?>" class="vDisolasi_metoda required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vDisolasi_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vDisolasi_mutu" value="<?php echo $row['vDisolasi_mutu'] ?>" class="vDisolasi_mutu required" style="width: 95%; text-align: left;"><?php echo nl2br($row['vDisolasi_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: left;">
							<table>
								<tr>
									<td>Mycoplasma</td>
									<td>:
										<textarea type="text" name="vKontaminasi_mico" value="<?php echo $row['vKontaminasi_mico'] ?>" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"><?php echo nl2br($row['vKontaminasi_mico']) ?></textarea>
									</td>
								</tr>
								<tr>
									<td>Salmonella</td>
									<td>:
										<textarea type="text" name="vKontaminasi_salmon" value="<?php echo $row['vKontaminasi_salmon'] ?>" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"><?php echo nl2br($row['vKontaminasi_salmon']) ?></textarea>
									</td>
								</tr>
								<tr>
									<td>Jamur</td>
									<td>:
										<textarea type="text" name="vKontaminasi_jamur" value="<?php echo $row['vKontaminasi_jamur'] ?>" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"><?php echo nl2br($row['vKontaminasi_jamur']) ?></textarea>
									</td>
								</tr>
								<tr>
									<td>E. Coli</td>
									<td>:
										<textarea type="text" name="vKontaminasi_coli" value="<?php echo $row['vKontaminasi_coli'] ?>" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"><?php echo nl2br($row['vKontaminasi_coli']) ?></textarea>
									</td>
								</tr>
								<tr>
									<td>Microorg. Hidup lain</td>
									<td>:
										<textarea type="text" name="vKontaminasi_lain" value="<?php echo $row['vKontaminasi_lain'] ?>" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"><?php echo nl2br($row['vKontaminasi_lain']) ?></textarea>
									</td>
								</tr>
							</table>
						</td>		
		...
		?>
				...
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vHomogen" value="" class="vHomogen required" style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vHomogen_metoda" value="" class="vHomogen_metoda required" style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vHomogen_mutu" value="" class="vHomogen_mutu required" style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- kevakuman -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vVakum" value="" class="vVakum required" style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vVakum_metoda" value="" class="vVakum_metoda required" style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vVakum_mutu" value="" class="vVakum_mutu required" style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
					...
					<td style="border: 1px solid #dddddd; width: 10%; text-align: left;">
						<table style="width: 100%; text-align: left;">
							<tr>
								<td style="width: 30%; text-align: left;">P. Apus</td>
								<td>:
									<textarea type="text" name="vMurni_apus" value="" class="vMurni required" style="width: 85%; text-align: left;"></textarea>
								</td>
							</tr>
							<tr>
								<td style="width: 30%; text-align: left;">37 &deg C</td>
								<td>:
									<textarea type="text" name="vMurni_37" value="" class="vMurni required" style="width: 85%; text-align: left;"></textarea>
								</td>
							</tr>
						</table>
					</td>
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vMurni_metoda" value="" class="vMurni_metoda required" style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vMurni_mutu" value="" class="vMurni_mutu required" style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
					...
					<td style="border: 1px solid #dddddd; width: 10%; text-align: left;">
						<table style="width: 95%; text-align: left;">
							<tr>
								<td style="width: 30%; text-align: left;">37 &deg C</td>
								<td>:
									<textarea type="text" name="vSteril_37" value="" class="vSteril required" style="width: 85%; text-align: left;"></textarea>
								</td>
							</tr>
							<tr>
								<td>22 &deg C</td>
								<td>:
									<textarea type="text" name="vSteril_22" value="" class="vSteril required" style="width: 85%; text-align: left;"></textarea>
								</td>
							</tr>
						</table>
					</td>
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril_metoda" value="" class="vSteril_metoda required" style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril_mutu" value="" class="vSteril_mutu required" style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- disolasi -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vDisolasi" value="" class="vDisolasi required" style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vDisolasi_metoda" value="" class="vDisolasi_metoda required" style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vDisolasi_mutu" value="" class="vDisolasi_mutu required" style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: left;">
						<table>
							<tr>
								<td>Mycoplasma</td>
								<td>:
									<textarea type="text" name="vKontaminasi_mico" value="" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"/>		
								</td>
							</tr>
							<tr>
								<td>Salmonella</td>
								<td>:
									<textarea type="text" name="vKontaminasi_salmon" value="" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"/>		
								</td>
							</tr>
							<tr>
								<td>Jamur</td>
								<td>:
									<textarea type="text" name="vKontaminasi_jamur" value="" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"/>		
								</td>
							</tr>
							<tr>
								<td>E. Coli</td>
								<td>:
									<textarea type="text" name="vKontaminasi_coli" value="" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"/>		
								</td>
							</tr>
							<tr>
								<td>Microorg. Hidup lain</td>
								<td>:
									<textarea type="text" name="vKontaminasi_lain" value="" class="vKontaminasi required" style="width: 85%; text-align: left;" text-align: left;"/>		
								</td>
							</tr>
						</table>
					</td>		
