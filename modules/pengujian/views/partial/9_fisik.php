		...
		?>	
				<!-- fisik -->
					...
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" value="<?php echo $row['vKelarutan'] ?>" name="vKelarutan" value="" class="vKelarutan " style="width: 95%; text-align: left;"><?php echo nl2br($row['vKelarutan']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" value="<?php echo $row['vKelarutan_metoda'] ?>" name="vKelarutan_metoda" value="" class="vKelarutan_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vKelarutan_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" value="<?php echo $row['vKelarutan_mutu'] ?>" name="vKelarutan_mutu" value="" class="vKelarutan_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vKelarutan_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
				...
				<!-- kevakuman -->
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" value="<?php echo $row['vSeragam'] ?>" name="vSeragam" class="vSeragam " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSeragam']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" value="<?php echo $row['vSeragam_metoda'] ?>" name="vSeragam_metoda"class="vSeragam_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSeragam_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" value="<?php echo $row['vSeragam_mutu'] ?>" name="vSeragam_mutu"  class="vSeragam_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSeragam_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
				...
				<!-- Ph -->
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" name="vPh" value="<?php echo $row['vPh'] ?>" class="vPh " style="width: 95%; text-align: left;"><?php echo nl2br($row['vPh']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vPh_metoda" value="<?php echo $row['vPh_metoda'] ?>" class="vPh_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vPh_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vPh_mutu" value="<?php echo $row['vPh_mutu'] ?>" class="vPh_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vPh_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
				...
				<!-- Identitas -->
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" name="vIdentitas" value="<?php echo $row['vIdentitas'] ?>" class="vIdentitas " style="width: 95%; text-align: left;"><?php echo nl2br($row['vIdentitas']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vIdentitas_metoda" value="<?php echo $row['vIdentitas_metoda'] ?>" class="vIdentitas_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vIdentitas_metoda']) ?></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vIdentitas_mutu" value="<?php echo $row['vIdentitas_mutu'] ?>" class="vIdentitas_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vIdentitas_mutu']) ?></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Steril37 -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vSteril37" value="<?php echo $row['vSteril37'] ?>" class="vSteril37 " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSteril37']) ?></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril37_metoda" value="<?php echo $row['vSteril37_metoda'] ?>" class="vSteril37_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSteril37_metoda']) ?></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril37_mutu" value="<?php echo $row['vSteril37_mutu'] ?>" class="vSteril37_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSteril37_mutu']) ?></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Steril22 -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vSteril22" value="<?php echo $row['vSteril22'] ?>" class="vSteril22 " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSteril22']) ?></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril22_metoda" value="<?php echo $row['vSteril22_metoda'] ?>" class="vSteril22_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSteril22_metoda']) ?></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril22_mutu" value="<?php echo $row['vSteril22_mutu'] ?>" class="vSteril22_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSteril22_mutu']) ?></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Kontaminasi -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vKontaminasi" value="<?php echo $row['vKontaminasi'] ?>" class="vKontaminasi " style="width: 95%; text-align: left;"><?php echo nl2br($row['vKontaminasi']) ?></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
			...
			<!-- Coli -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vColi" value="<?php echo $row['vColi'] ?>" class="vColi " style="width: 95%; text-align: left;"><?php echo nl2br($row['vColi']) ?></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vColi_metoda" value="<?php echo $row['vColi_metoda'] ?>" class="vColi_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vColi_metoda']) ?></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vColi_mutu" value="<?php echo $row['vColi_mutu'] ?>" class="vColi_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vColi_mutu']) ?></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Salmon -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vSalmon" value="<?php echo $row['vSalmon'] ?>" class="vSalmon " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSalmon']) ?></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSalmon_metoda" value="<?php echo $row['vSalmon_metoda'] ?>" class="vSalmon_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSalmon_metoda']) ?></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSalmon_mutu" value="<?php echo $row['vSalmon_mutu'] ?>" class="vSalmon_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vSalmon_mutu']) ?></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Toksis -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vToksis" value="<?php echo $row['vToksis'] ?>" class="vToksis " style="width: 95%; text-align: left;"><?php echo nl2br($row['vToksis']) ?></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vToksis_metoda" value="<?php echo $row['vToksis_metoda'] ?>" class="vToksis_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vToksis_metoda']) ?></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vToksis_mutu" value="<?php echo $row['vToksis_mutu'] ?>" class="vToksis_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vToksis_mutu']) ?></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Pirogen -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vPirogen" value="<?php echo $row['vPirogen'] ?>" class="vPirogen " style="width: 95%; text-align: left;"><?php echo nl2br($row['vPirogen']) ?></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vPirogen_metoda" value="<?php echo $row['vPirogen_metoda'] ?>" class="vPirogen_metoda " style="width: 95%; text-align: left;"><?php echo nl2br($row['vPirogen_metoda']) ?></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vPirogen_mutu" value="<?php echo $row['vPirogen_mutu'] ?>" class="vPirogen_mutu " style="width: 95%; text-align: left;"><?php echo nl2br($row['vPirogen_mutu']) ?></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
				...
				<!-- lain -->
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						<td colspan="2" style="border: 1px solid #dddddd; width: 10%; text-align: left;">
							<b>Potensi<B>
							<br>
							<textarea type="text" name="vPotensi_object" value="<?php echo $row['vPotensi_object'] ?>" class="vPotensi_object " style="width: 95%; text-align: left;"><?php echo nl2br($row['vPotensi_object']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" name="vPotensi" value="<?php echo $row['vPotensi'] ?>" class="vPotensi " style="width: 95%; text-align: left;"><?php echo nl2br($row['vPotensi']) ?></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
		...
		?>
				<!-- fisik -->
					...
					<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
						...
						<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
							<textarea type="text" name="vKelarutan" value="" class="vKelarutan " style="width: 95%; text-align: left;"></textarea>
						</td>		
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vKelarutan_metoda" value="" class="vKelarutan_metoda " style="width: 95%; text-align: left;"></textarea>
						</td>	
						<td style="border: 1px solid #dddddd; width: 25%">
							<textarea type="text" name="vKelarutan_mutu" value="" class="vKelarutan_mutu " style="width: 95%; text-align: left;"></textarea>
						</td>
						<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- kevakuman -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vSeragam" value="" class="vSeragam " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSeragam_metoda" value="" class="vSeragam_metoda " style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSeragam_mutu" value="" class="vSeragam_mutu " style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Ph -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vPh" value="" class="vPh " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vPh_metoda" value="" class="vPh_metoda " style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vPh_mutu" value="" class="vPh_mutu " style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Steril37 -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vSteril37" value="" class="vSteril37 " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril37_metoda" value="" class="vSteril37_metoda " style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril37_mutu" value="" class="vSteril37_mutu " style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Steril22 -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vSteril22" value="" class="vSteril22 " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril22_metoda" value="" class="vSteril22_metoda " style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSteril22_mutu" value="" class="vSteril22_mutu " style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Kontaminasi -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vKontaminasi" value="" class="vKontaminasi " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
			...
			<!-- Coli -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vColi" value="" class="vColi " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vColi_metoda" value="" class="vColi_metoda " style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vColi_mutu" value="" class="vColi_mutu " style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Salmon -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vSalmon" value="" class="vSalmon " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSalmon_metoda" value="" class="vSalmon_metoda " style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vSalmon_mutu" value="" class="vSalmon_mutu " style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Toksis -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vToksis" value="" class="vToksis " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vToksis_metoda" value="" class="vToksis_metoda " style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vToksis_mutu" value="" class="vToksis_mutu " style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- Pirogen -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					...
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vPirogen" value="" class="vPirogen " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vPirogen_metoda" value="" class="vPirogen_metoda " style="width: 95%; text-align: left;"></textarea>
					</td>	
					<td style="border: 1px solid #dddddd; width: 25%">
						<textarea type="text" name="vPirogen_mutu" value="" class="vPirogen_mutu " style="width: 95%; text-align: left;"></textarea>
					</td>
					<td style="border: 1px solid #dddddd; width: 10%">
			...
			<!-- lain -->
				<tr style="border: 1px solid #dddddd; border-collapse: collapse; background: #ffffff; ">
					<td colspan="2" style="border: 1px solid #dddddd; width: 10%; text-align: left;">
						<b>Potensi<b>
						<br>
						<textarea type="text" name="vPotensi_object" value="" class="vPotensi_object " style="width: 95%; text-align: left;"></textarea>
							
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%; text-align: center;">
						<textarea type="text" name="vPotensi" value="" class="vPotensi " style="width: 95%; text-align: left;"></textarea>
					</td>		
					<td style="border: 1px solid #dddddd; width: 25%">
