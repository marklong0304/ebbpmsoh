...
<!-- table pengujian -->
  ...
  <table class="tg" style="width: 100%;">
    ...
    <tr>
      <td class="tg-0lax">Kelarutan<br><span style="font-style:italic">Solubility</span><br></td>
      <td class="tg-0lax"><?php echo $item[0]->KELARUTAN1; ?></td>
      <td class="tg-0lax"><?php echo $item[0]->KELARUTAN2; ?></td>
      <td class="tg-0lax"><?php echo $item[0]->KELARUTAN3; ?></td>
      <td class="tg-0lax"><?php echo $item[0]->KELARUTAN4; ?></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="tg-0lax" colspan="2">Keasaman Kebasaan (pH)<br>Acidity Alkalinity</td>
      <td class="tg-0lax"><?php echo $item[0]->KEASAMAN1; ?></td>
      <td class="tg-0lax"><?php echo $item[0]->KEASAMAN2; ?></td>
      <td class="tg-0lax"><?php echo $item[0]->KEASAMAN3; ?></td>
      <td class="tg-0lax"><?php echo $item[0]->KEASAMAN4; ?></td>
    </tr>
    <tr>
...
<!--     <tr>
    ...
    <tr>
      <td class="tg-0lax" colspan="2">Pirogenitas<br><span style="font-style:italic">Pyrogenity</span></td>
      <td class="tg-0lax"><?php echo $item[0]->PIROGENITAS1 ?></td>
      <td class="tg-0lax"><?php echo $item[0]->PIROGENITAS2 ?></td>
      <td class="tg-0lax"><?php echo $item[0]->PIROGENITAS3 ?></td>
      <td class="tg-0lax"><?php echo $item[0]->PIROGENITAS4 ?></td>
    </tr>
    <tr>
      <td class="tg-0lax" colspan="2">Kadar / Potensi<br><span style="font-style:italic">Purity / Potency</span></td>
