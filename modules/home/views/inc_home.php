	        ...
	        add: function(e, ui) {
	            $(ui.tab).parents('li:first')
	                ...
	                .click(function() {
						...
						var modul_id_ = ui.panel.id;
						var modul_id__ = modul_id_.split('_');
						modul_id_ = modul_id__[1];
						
						//console.log(modul_id_); 
	                    var pathModul = '<?php echo base_url()?>infomodule';
	                    //console.log(pathModul);  

	                    $.post( pathModul, {moduleId:modul_id_, reset_:"ok"}, function( data ) {
