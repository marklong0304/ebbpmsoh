        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-10-05 09:36:54 */
        /* Location: ./modules/schedulercheck/controllers/dbsteril_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='dbsteril_nvl';
               - $BackdateI='360';
               - $tbsql='prdtrial.DBSTERIL';
               - $pk=odbc_result($rs,'c_kode');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_kode').' - '.odbc_result($rs,'c_kode');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='DBSTERIL';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PRDTRIAL/DBSTERIL.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/DATA/PRDTRIAL/DBSTERIL.dbf');
