        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-22 17:40:44 */
        /* Location: ./modules/schedulercheck/controllers/divisi_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='divisi_etc';
               - $BackdateI='1';
               - $tbsql='sales.divisi';
               - $pk=odbc_result($rs,'c_teamc');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_teamc').' - '.odbc_result($rs,'c_descr');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='divisi';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/sales/divisi.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/sales/divisi.dbf');
            $dbfDir = dirname($dbfFile);
            $dbfDir1 = 'G:/data/emba/sales';
