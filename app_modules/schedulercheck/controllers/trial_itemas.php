        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-22 14:36:17 */
        /* Location: ./modules/schedulercheck/controllers/trial_itemas.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='trial_itemas';
               - $BackdateI='1';
               - $tbsql='prdtrial.itemas';
               - $pk=odbc_result($rs,'C_iteno');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_iteno').' - '.odbc_result($rs,'C_itnam');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='itemas';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PRDTRIAL/itemas.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/DATA/PRDTRIAL/itemas.dbf');
