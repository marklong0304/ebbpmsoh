        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:25:16 */
        /* Location: ./modules/schedulercheck/controllers/ws_recentqa_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_recentqa_etc';
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='ws_recentqa_etc';
               - $BackdateI='360';
               - $tbsql='sales.recentqa';
               - $pk=odbc_result($rs,'C_DNNUMB');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_DNNUMB').' - '.odbc_result($rs,'C_DNNUMB');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='recentqa';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/SALES/recentqa.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_recentqa_etc.bat%'"; 
            ...
            $db='sales';
            $dbfFile = realpath('G:/ETERCON/DATA/SALES/recentqa.dbf');
