        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 12:02:01 */
        /* Location: ./modules/schedulercheck/controllers/trial_prosroot_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='trial_prosroot_etc';
               - $BackdateI='1';
               - $tbsql='prdtrial.prosroot';
               - $pk=odbc_result($rs,'c_iteno');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_iteno').' - '.odbc_result($rs,'c_iteno');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='prosroot';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/prdtrial/prosroot.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/prdtrial/prosroot.dbf');
