        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:23:26 */
        /* Location: ./modules/menu/controllers/ws_potr04_nvl.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_potr04_nvl';
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_potr04_nvl.bat%'"; 
            ...
            $db='purchase';
            $dbfFile = realpath('G:/DATA/PURCHASE/potr04.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_KET '.$fk_1.' AND a.C_KET '.$fk_2.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_KET '.$fk_1.' AND C_KET '.$fk_2.'   AND iCompanyID= '.$selectCompany.' ' ;
