        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-10-05 09:53:56 */
        /* Location: ./modules/schedulercheck/controllers/forma_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='forma_nvl';
               - $BackdateI='360';
               - $tbsql='prdtrial.FORMA';
               - $pk=odbc_result($rs,'c_iteno,c_itemnumb');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_iteno,c_itemnumb').' - '.odbc_result($rs,'c_iteno');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='FORMA';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PRDTRIAL/FORMA.dbf');
               - $sql='SELECT * FROM '.$dbFile.' where D_LSTUPDA BETWEEN #$tgl1# AND #$tgl2#';
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/DATA/PRDTRIAL/FORMA.dbf');
