        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-11-17 17:16:03 */
        /* Location: ./modules/schedulercheck/controllers/dsrtjln_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               ...
               - $dbFile='dsrtjln';
               - $dbfFile = realpath('//10.1.48.21/Sys2/APLIKASI/VF/Vitalsign/srtjln/dsrtjln.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
              ...
              $backback2 = strtotime('+ 1 days', strtotime($tgl2));
              $tgl1 = date('Ymd', $backback);
              $tgl2 = date('Ymd', $backback2);
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
               ...
               if($last_update<>'-'){
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $pk1=odbc_result($rs,'C_INVNO');
                    $fPk1='C_INVNO';

                    $pk2=odbc_result($rs,'C_ITENO');
                    $fPk2='C_ITENO';

                    $pk3=odbc_result($rs,'C_PANUMB');
                    $fPk3='C_PANUMB';

                    $pk4=odbc_result($rs,'C_LOT');
                    $fPk4='C_LOT';
                    ...
                    $sqlUdah = 'select * from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and a.'.$fPk1.'= "'.$pk1.'" and a.'.$fPk2.'= "'.$pk2.'" and a.'.$fPk3.'= "'.$pk3.'" and a.'.$fPk4.'= "'.$pk4.'"' ;
                    ...
                    if (!empty($rowUdah)) 
                    {
                      ...
                      $i=0;
                       ...
                       $sa.=' where  '.$fPk.'  = "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and '.$fPk1.'= "'.$pk1.'" and '.$fPk2.'= "'.$pk2.'" and '.$fPk3.'= "'.$pk3.'" and '.$fPk4.'= "'.$pk4.'" ';
