        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-08-29 08:49:33 */
        /* Location: ./modules/schedulercheck/controllers/kategori.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='kategori';
               - $BackdateI='1';
               - $tbsql='mrp.kategori';
               - $pk=odbc_result($rs,'c_kategori');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_kategori').' - '.odbc_result($rs,'c_nmkateg');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='kategori';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/MRP/kategori.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='mrp';
            $dbfFile = realpath('G:/DATA/MRP/kategori.dbf');
