        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:28:40 */
        /* Location: ./modules/menu/controllers/ws_order03_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_order03_etc';
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_order03_etc.bat%'"; 
            ...
            $db='purchase';
            $dbfFile = realpath('G:/ETERCON/DATA/PURCHASE/order03.dbf');
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $fk_1=odbc_result($rs,'C_ORNUMB');
                              ...
                              if(trim($fk_2)==''){
                                        ...
                                        $fk_3=odbc_result($rs,'C_ITEMNUMB');
                              if(trim($fk_3)==''){
                                              $fk_3 = ' is NULL';
                                            }else{
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_ORNUMB '.$fk_1.' AND a.C_ITEMNUMB '.$fk_2.' AND a.C_ITEMNUMB '.$fk_3.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_ORNUMB '.$fk_1.' AND C_ITEMNUMB '.$fk_2.' AND C_ITEMNUMB '.$fk_3.'   AND iCompanyID= '.$selectCompany.' ' ;
