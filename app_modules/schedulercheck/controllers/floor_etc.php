        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-04-11 11:18:48 */
        /* Location: ./modules/home/controllers/floor_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='floor_etc';
               - $BackdateI='1';
               - $tbsql='purchase.floor';
               - $pk=odbc_result($rs,'c_floor');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_floor').' - '.odbc_result($rs,'c_nmfloor');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='floor';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/EMBA/PURCHASE/floor.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $openDatabase = 'purchase';
            $dbfFile = realpath('G:/ETERCON/DATA/PURCHASE/floor.dbf');
                ...
                if (!$rs)
                 ...
                 /*--------Create Table if not exist -------*/
                  ...
                  $sqlCekfield = 'SELECT c.COLUMN_NAME
                                    ...
                                    c.TABLE_SCHEMA = '.$openDatabase.'  AND c.TABLE_NAME= '.$dbFile.'';   
                  ...
                  if(!empty($setArrayAlter)){
                    foreach ($setArrayAlter as $key => $valueIns) {
                      ...
                      $KolomType=get_type($kDKolom);    
                      $sqlAlter = 'ALTER TABLE purchase.manufac ADD '.$valueIns.' '.$KolomType['jenis'].' '.$KolomType['fld'].' NULL'; 
