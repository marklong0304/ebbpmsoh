        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-09-04 11:41:16 */
        /* Location: ./modules/schedulercheck/controllers/nilaiven_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='nilaiven_nvl';
               - $BackdateI='1';
               - $tbsql='purchase.nilaiven';
               - $pk=odbc_result($rs,'c_supnumb');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_supnumb').' - '.odbc_result($rs,'c_supnumb');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='nilaiven';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PURCHASE/nilaiven.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/DATA/PURCHASE/nilaiven.dbf');
