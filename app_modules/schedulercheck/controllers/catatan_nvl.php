        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-10-05 09:20:52 */
        /* Location: ./modules/schedulercheck/controllers/catatan_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='catatan_nvl';
               - $BackdateI='360';
               - $tbsql='prdtrial.CATATAN';
               - $pk=odbc_result($rs,'c_iteno');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_iteno').' - '.odbc_result($rs,'c_iteno');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='CATATAN';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PRDTRIAL/CATATAN.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/DATA/PRDTRIAL/CATATAN.dbf');
