        ...
        /* Location: ./modules/schedulercheck/controllers/hsrtjln_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               ...
               - $dbFile='hsrtjln';
               - $dbfFile = realpath('//10.1.48.21/Sys2/APLIKASI/VF/Vitalsign/srtjln/hsrtjln.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/DATA/SALES/hsrtjln.dbf');
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
               ...
               if($last_update<>'-'){
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $pk1=odbc_result($rs,'C_CODE');
                    $fPk1='C_CODE';

                    $pk2=odbc_result($rs,'C_CUSNO');
                    $fPk2='C_CUSNO';
                   ...
                   // $sqlUdah = 'select * from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'" and  iCompanyID = "'.$selectCompany.'"  and a.'.$fPk1.'= "'.$pk1.'" and a.'.$fPk2.'= "'.$pk2.'"' ;
