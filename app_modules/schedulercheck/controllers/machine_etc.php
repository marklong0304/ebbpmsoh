        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 13:44:50 */
        /* Location: ./modules/schedulercheck/controllers/machine_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='machine_etc';
               - $BackdateI='1';
               - $tbsql='MRP.machine';
               - $pk=odbc_result($rs,'c_machine');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_machine').' - '.odbc_result($rs,'c_machine');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='machine';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/mrp/machine.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/mrp/machine.dbf');
