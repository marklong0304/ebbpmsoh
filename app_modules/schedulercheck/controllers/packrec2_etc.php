        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 13:56:42 */
        /* Location: ./modules/schedulercheck/controllers/packrec2_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='packrec2_etc';
               - $BackdateI='1';
               - $tbsql='MRP.packrec2';
               - $pk=odbc_result($rs,'c_urut');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_urut').' - '.odbc_result($rs,'c_urut');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='packrec2';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/mrp/packrec2.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/mrp/packrec2.dbf');
