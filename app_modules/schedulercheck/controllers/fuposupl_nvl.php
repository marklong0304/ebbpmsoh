        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-09-04 10:54:15 */
        /* Location: ./modules/schedulercheck/controllers/fuposupl_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='fuposupl_nvl';
               - $BackdateI='1';
               - $tbsql='purchase.fuposupl';
               - $pk=odbc_result($rs,'c_syskey');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_syskey').' - '.odbc_result($rs,'c_syskey');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='fuposupl';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PURCHASE/fuposupl.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/DATA/PURCHASE/fuposupl.dbf');
