        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 13:31:36 */
        /* Location: ./modules/schedulercheck/controllers/standard_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='standard_etc';
               - $BackdateI='1';
               - $tbsql='purchase.standard';
               - $pk=odbc_result($rs,'c_standard');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_standard').' - '.odbc_result($rs,'c_standard');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='standard';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/purchase/standard.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/purchase/standard.dbf');
