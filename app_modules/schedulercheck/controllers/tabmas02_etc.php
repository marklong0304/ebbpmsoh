        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 11:28:27 */
        /* Location: ./modules/schedulercheck/controllers/tabmas02_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='tabmas02_etc';
               - $BackdateI='1';
               - $tbsql='sales.tabmas02';
               - $pk=odbc_result($rs,'c_lisensi');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_lisensi').' - '.odbc_result($rs,'c_lisensi');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='tabmas02';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/emba/SALES/tabmas02.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/DATA/emba/SALES/tabmas02.dbf');
