        ...
        /* Location: ./modules/schedulercheck/controllers/order04_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='order04_etc';
               - $BackdateI='1';
               - $tbsql='purchase.order04';
               - $pk=odbc_result($rs,'c_ornumb');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_ornumb').' - '.odbc_result($rs,'c_ornumb');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='order04';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/purchase/order04.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/purchase/order04.dbf');
