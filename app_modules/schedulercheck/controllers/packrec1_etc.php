        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 13:54:13 */
        /* Location: ./modules/schedulercheck/controllers/packrec1_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='packrec1_etc';
               - $BackdateI='1';
               - $tbsql='MRP.packrec1';
               - $pk=odbc_result($rs,'c_kemas');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_kemas').' - '.odbc_result($rs,'c_kemas');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='packrec1';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/mrp/packrec1.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/mrp/packrec1.dbf');
