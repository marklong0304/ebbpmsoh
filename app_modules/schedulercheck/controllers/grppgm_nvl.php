        ...
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-10-05 14:57:32 */
        /* Location: ./modules/schedulercheck/controllers/grppgm_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='grppgm_nvl';
               - $BackdateI='360';
               - $tbsql='prdtrial.GRPPGM';
               - $pk=odbc_result($rs,'C_PGMNO');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_PGMNO').' - '.odbc_result($rs,'-');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='GRPPGM';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PRDTRIAL/GRPPGM.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/DATA/PRDTRIAL/GRPPGM.dbf');
