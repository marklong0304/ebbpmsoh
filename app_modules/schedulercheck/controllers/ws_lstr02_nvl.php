        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:07:08 */
        /* Location: ./modules/menu/controllers/ws_lstr02_nvl.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_lstr02_nvl';
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='ws_lstr02_nvl';
               - $BackdateI='360';
               - $tbsql='purchase.lstr02';
               - $pk=odbc_result($rs,'C_LSANUMB');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_LSANUMB').' - '.odbc_result($rs,'C_LSANUMB');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='lstr02';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PURCHASE/lstr02.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_lstr02_nvl.bat%'"; 
            ...
            $db='purchase';
            $dbfFile = realpath('G:/DATA/PURCHASE/lstr02.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_ITEMNUMB '.$fk_1.' AND a.C_ITEMNUMB '.$fk_2.' AND a.C_LPBNUMB '.$fk_3.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_ITEMNUMB '.$fk_1.' AND C_ITEMNUMB '.$fk_2.' AND C_LPBNUMB '.$fk_3.'   AND iCompanyID= '.$selectCompany.' ' ;
