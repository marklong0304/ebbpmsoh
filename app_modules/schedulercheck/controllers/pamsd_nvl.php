        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-03-22 08:39:49 */
        /* Location: ./modules/schedulercheck/controllers/pamsd_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='PAMSD_NVL';
               - $BackdateI='1';
               - $tbsql='purchase.PAMSD';
               - $pk=odbc_result($rs,'C_PANUMB');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_PANUMB').' - '.odbc_result($rs,'C_ITEMNUMB');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                if (!$rs)
                 ...
                 /*--------Create Table if not exist -------*/
                  ...
                  $sqlCekfield = 'SELECT c.COLUMN_NAME
                                    ...
                                    c.TABLE_SCHEMA = '.$openDatabase.'  AND c.TABLE_NAME= '.$nm_dbf.'';   
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select * from '.$tbsql.' a where a.iCompanyID=  
                                  AND a.'.$fPk.'= "'.$pk.'"' ;
