        ...
        /* Generated by Sovdev 2 ERP CRUD Generator 2018-10-05 14:54:20 */
        /* Location: ./modules/schedulercheck/controllers/grpid_nvl.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='grpid_nvl';
               - $BackdateI='360';
               - $tbsql='prdtrial.GRPID';
               - $pk=odbc_result($rs,'C_GROUP');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_GROUP').' - '.odbc_result($rs,'-');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='GRPID';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PRDTRIAL/GRPID.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/DATA/PRDTRIAL/GRPID.dbf');
