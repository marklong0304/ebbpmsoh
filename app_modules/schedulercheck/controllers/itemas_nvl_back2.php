        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-11-30 09:40:00 */
        /* Location: ./modules/menu/controllers/itemas_nvl.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='itemas_nvl';
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $db='sales';
            $dbfFile = realpath('G:/\DATA\SALES/ITEMAS.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
            echo "sampe abis parameter";
                ...
                if (!$rs)
                 ...
                 echo "sampe get last update data";
                 ...
                 echo "sampe array kolom ";

                 /*Check Mysql Table and Field Start*/
                    cekTableandField($arrNmKolom);

                 /*Check Mysql Table and field End*/
                 echo "sampe cek Table and field";
                 exit;  
           ...
           /*------------------------------------------------------Processing Data End------------------------------------------------------*/
                ...
                function cekTableAndField1(array $arrNmKolom){
                  print_r($arrNmKolom);

                }

                function cekTableAndFieldx(array $arrNmKolom){
                 ...
                 /*--------Create Table if not exist -------*/ 
                  ...
                  $cmd = "curl -XPOST -d 'lang=id&inbox_id=".$insert_id."' 'https://gpsmsg.dev2.novellpharm.com/api/gpsmsg-send-byinbox'";
                ...
                function insertUpdateSql(){
                      ...
                      $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_ITENO '.$fk_1.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_ITENO '.$fk_1.'   ';
