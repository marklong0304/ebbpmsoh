        ...
        <?php
        /* Generated by Sovdev 2 ERP CRUD Generator 2017-08-23 11:33:40 */
        /* Location: ./modules/schedulercheck/controllers/usulan_etc.php */
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='usulan_etc';
               - $BackdateI='1';
               - $tbsql='prdtrial.usulan';
               - $pk=odbc_result($rs,'c_usulan');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'c_usulan').' - '.odbc_result($rs,'c_usulan');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='usulan';
               - $dbfFile = realpath('//10.1.48.21/Sys2/data/emba/rawmat/usulan.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $dbfFile = realpath('G:/data/emba/rawmat/usulan.dbf');
            $dbfDir = dirname($dbfFile);
            $dbfDir1 = 'G:/data/emba/rawmat';
