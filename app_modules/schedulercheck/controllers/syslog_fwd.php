<?php 
	...
	function wsWriteLog($schname,$message){
		...
		//set POST variables
		$url = 'http://ws.novellpharm.npl/api/write2Log';
		$fields = array(
		            'message' => $strRaw,
		            'schname' => $schname,
	...
	function runSQLCreateTable ($sqlRaw,$schname){
		...
		$strRaw = str_replace(array("\r\n", "\n", "\r"), ' ', $sqlRaw);
		//set POST variables
		$url = 'http://ws.novellpharm.npl/api/sqlCreateTable';
		$fields = array(
		            'sqlRaw' => $strRaw,
		            'schname' => $schname,
		            'api_key' => urlencode("1234")
	...
	function runSQLRaw ($sqlRaw,$schname){
		...
		$strRaw = str_replace(array("\r\n", "\n", "\r"), ' ', $sqlRaw);
		//set POST variables
		$url = 'http://ws.novellpharm.npl/api/sqlUdah';
		$fields = array(
		            'sqlRaw' => $strRaw,
		            'schname' => $schname,
		            'api_key' => urlencode("1234")
	...
	function runSQLAlterTableGetField($db,$table,$schname){
		...
		//$strRaw = str_replace(array("\r\n", "\n", "\r"), ' ', $sqlRaw);
		//set POST variables
		$url = 'http://ws.novellpharm.npl/api/sqlGetField';
		$fields = array(
		            'debe' => $db,
		            'tabel' => $table,
		            'schname' => $schname,
	...
	function runSQLAlterTableProses($sqlRaw,$schname){
		...
		$strRaw = str_replace(array("\r\n", "\n", "\r"), ' ', $sqlRaw);
		//set POST variables
		$url = 'http://ws.novellpharm.npl/api/sqlProsesAlter';
		$fields = array(
		            'sqlRaw' => $strRaw,
		            'schname' => $schname,
		            'api_key' => urlencode("1234")
	...
	function runSQLInsert ($sqlRaw,$schname){
		...
		$strRaw = str_replace(array("\r\n", "\n", "\r"), ' ', $sqlRaw);
		//set POST variables
		$url = 'http://ws.novellpharm.npl/api/sqlInsert';
		$fields = array(
		            'sqlRaw' => $strRaw,
		            'schname' => $schname,
		            'api_key' => urlencode("1234")
	...
	function runSQLUpdate ($sqlRaw,$schname){
		...
		$strRaw = str_replace(array("\r\n", "\n", "\r"), ' ', $sqlRaw);
		//set POST variables
		$url = 'http://ws.novellpharm.npl/api/sqlUpdate';
		$fields = array(
		            'sqlRaw' => $strRaw,
		            'schname' => $schname,
		            'api_key' => urlencode("1234")
