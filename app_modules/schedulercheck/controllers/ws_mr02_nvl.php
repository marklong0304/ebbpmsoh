        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:16:53 */
        /* Location: ./modules/menu/controllers/ws_mr02_nvl.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_mr02_nvl';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $BackdateI='360';
               - $tbsql='purchase.mr02';
               - $pk=odbc_result($rs,'C_MRNO');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_MRNO').' - '.odbc_result($rs,'C_MRNO');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='mr02';
               - $dbfFile = realpath('//10.1.48.21/Sys2/DATA/PURCHASE/mr02.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_mr02_nvl.bat%'"; 
            ...
            $db='purchase';
            $dbfFile = realpath('G:/DATA/PURCHASE/mr02.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_ITEMNUMB '.$fk_1.' AND a.C_ITEMNUMB '.$fk_2.' AND a.C_BATCHNO '.$fk_3.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_ITEMNUMB '.$fk_1.' AND C_ITEMNUMB '.$fk_2.' AND C_BATCHNO '.$fk_3.'   AND iCompanyID= '.$selectCompany.' ' ;
