        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:57:46 */
        /* Location: ./modules/schedulercheck/controllers/ws_trial_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_trial_etc';
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_trial_etc.bat%'"; 
            ...
            $db='prdtrial';
            $dbfFile = realpath('G:/ETERCON/DATA/PRDTRIAL/trial.dbf');
          ...
          /*------------------------------------------------------Parameter Start------------------------------------------------------*/
           ...
           /*------------------------------------------------------Parameter End------------------------------------------------------*/
                ...
                while (odbc_fetch_row($rs))
                {
                    ...
                    $pk=odbc_result($rs,'C_ITENO'); 
                    $fk_1=odbc_result($rs,'C_ITENONEW');
                              if(trim($fk_1)==''){
                                              $fk_1 = ' is NULL';
                                            }else{
                    ...
                    $sqlUdah = 'select a.* from '.$tbsql.' a where a.'.$fPk.'= "'.$pk.'"  AND a.C_ITENONEW '.$fk_1.' and a.iCompanyID= '.$selectCompany.' ' ;
                    ...
                    if ($rowcount['rowcount'] > 0) 
                    {
                      ...
                      $i=0;
                        ...
                        $sa.=' where  '  .$fPk. '   = "'.$pk.'"  AND C_ITENONEW '.$fk_1.'   AND iCompanyID= '.$selectCompany.' ' ;
