        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:25:49 */
        /* Location: ./modules/schedulercheck/controllers/ws_spams01_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_spams01_etc';
        ...
        /*
         ...
         3. Parameter 
               ...
               - $BackdateI='360';
               - $tbsql='sales.spams01';
               - $pk=odbc_result($rs,'C_CORNOAMS');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_CORNOAMS').' - '.odbc_result($rs,'C_CORNOAMS');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='spams01';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/SALES/spams01.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_spams01_etc.bat%'"; 
            ...
            $db='sales';
            $dbfFile = realpath('G:/ETERCON/DATA/SALES/spams01.dbf');
