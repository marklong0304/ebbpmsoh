        ...
        /* Generated by Softdev 2 ERP CRUD Generator 2018-12-10 14:32:04 */
        /* Location: ./modules/menu/controllers/ws_supplier_etc.php */
        /* Please DO NOT modify this information : */ 
         
          /*------------------------------------------------------New------------------------------------------------------*/
            $scheduler_name='ws_supplier_etc';
        ...
        /*
         ...
         3. Parameter 
               - $scheduler_name='ws_supplier_etc';
               - $BackdateI='360';
               - $tbsql='purchase.supplier';
               - $pk=odbc_result($rs,'C_SUPNUMB');
               - $fPk='C_FACCODE';
               - $pkv=odbc_result($rs,'C_SUPNUMB').' - '.odbc_result($rs,'C_SUPNUMB');
               - $tbsch = 'plc2.scheduler_score';
               - $dbFile='supplier';
               - $dbfFile = realpath('//10.1.48.21/Sys2/ETERCON/DATA/PURCHASE/supplier.dbf');
      ...
      */
        ...
        /*------------------------------------------------------Instuction------------------------------------------------------*/
           ...
           /*------------------------------------------------------Mysql Connection End------------------------------------------------------*/
            ...
            $cari = "CommandLine like '%ws_supplier_etc.bat%'"; 
            ...
            $db='purchase';
            $dbfFile = realpath('G:/ETERCON/DATA/PURCHASE/supplier.dbf');
