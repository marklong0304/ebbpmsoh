...
-- Dumping data for table bbpmsoh.mt01: ~12 rows (approximately)
DELETE FROM `mt01`;
...
-- Dumping data for table bbpmsoh.mt07: ~1 rows (approximately)
DELETE FROM `mt07`;
...
-- Dumping data for table erp_privi.privi_actilog: ~147 rows (approximately)
...
INSERT INTO `privi_session_log` (`idprivi_session_hist`, `cNip`, `iCompanyId`, `vSessionID`, `dLoginAt`, `dLogoutAt`, `vIPSource`, `tUpdatedAt`, `cUpdatedBy`) VALUES
	(217, 'N14615', 3, 'p1u4sb8pmlv9nr9ge85bov6n31', '2019-04-15 00:06:53', '0000-00-00 00:00:00', '127.0.0.1', NULL, NULL),
	(218, 'N14616', 3, 'popjijkdeg2mmdn6thghob2qo2', '2019-01-26 13:40:33', '2019-01-26 13:40:33', '127.0.0.1', NULL, NULL),
	(219, 'A00001', 3, '50qkvbljv404qkdkvrv69kghk3', '2019-04-15 00:06:45', '0000-00-00 00:00:00', '::1', NULL, NULL),
...
-- Dumping data for table gps_msg.erp_inbox: ~41 rows (approximately)
