...
-- Membuang data untuk tabel bbpmsoh.mt01: ~4 rows (lebih kurang)
DELETE FROM `mt01`;
...
INSERT INTO `mt01` (`iMt01`, `vNo_transaksi`, `vNomor`, `vLampiran`, `vPerihal`, `dTanggal`, `iCustomer`, `iType_pemohon`, `vNama_produsen`, `vAlamat_produsen`, `iM_tujuan_pengujian`, `vTujuan_pengujian_ket`, `vNama_sample`, `iM_jenis_sediaan`, `vJenis_sediaan_ket`, `iSudah_beredar`, `vZat_aktif`, `vBatch_lot`, `dTgl_produksi`, `dTgl_kadaluarsa`, `vNo_registrasi`, `vKemasan`, `iJumlah_diserahkan`, `vSuhu_penyimpanan`, `vPermohonan_lampiran`, `dTgl_ambil_sample`, `dTgl_serah_sample`, `vPimpinan_perusahaan`, `lDeleted`, `iSubmit`, `iApprove`, `dApprove`, `cApprove`, `vRemark`, `cCreated`, `dCreated`, `cUpdated`, `dUpdated`) VALUES
	(1, 'R00001', 'aa', 'aa', 'aa', '2019-02-03', 'C00011', 1, 'aa', 'aa', 1, 'a', 'aa', 1, NULL, 1, 'aa', 'aa', '2019-02-03', '2019-02-03', 'aaa', 'aaa', 12, '32', 'ss', '2019-02-03', '2019-02-03', 'Hiro Ahza', 0, 1, 2, '2019-02-23 14:31:53', 'N14615', 'reject', 'C00001', '2019-02-03 22:01:52', 'N14615', '2019-03-31 15:55:20'),
	(2, 'R00002', 'Vitamin', 'Lamp Vit', 'Penggemuk Badan', '2019-02-03', 'C00011', 1, 'PT Langsing', 'Di Kontrakan', 2, 'Tujuannya bikin gemuk', 'Susu Ultra', 1, 'Susu', 1, 'Protein', 'BTCH02x', '2019-02-03', '2019-02-03', 'NOREG0123SA', 'Bottle', 10, '10', 'Bagus', '2019-02-03', '2019-02-03', 'Kora', 0, 1, 2, '2019-02-23 14:02:01', 'N14615', 'approve', 'C00001', '2019-02-03 22:01:52', 'N14615', '2019-03-31 15:45:51'),
	(3, 'R00003', 'NOSAMPLE', 'LAMP', 'Uji Sample', '2019-02-12', 'C00011', 1, 'SERBA ADA', 'DESA SEBELAH', 1, '', 'SAMPLE BUAH', 1, NULL, 1, 'TEST', 'BATCH', '2019-02-27', '2019-02-23', 'No Req', 'Tablet', 10, '32', 'ST', '2019-02-28', '2019-02-28', 'OKE', 1, 1, 0, NULL, NULL, NULL, 'N14615', '2019-02-12 22:32:30', NULL, '2019-03-31 15:45:52'),
	(4, 'R00004', 'NOSAMPLE', 'LAMP', 'Uji Sample', '2019-02-12', 'C00011', 1, 'SERBA ADA', 'DESA SEBELAH', 1, '', 'SAMPLE BUAH', 1, NULL, 1, 'TEST', 'BATCH', '2019-02-27', '2019-02-23', 'No Req', 'Tablet', 10, '32', 'ST', '2019-02-28', '2019-02-28', 'OKE', 0, 1, 0, NULL, NULL, NULL, 'N14615', '2019-02-12 22:33:54', NULL, '2019-03-31 15:45:52'),
	(5, 'R00005', 'No X201231', 'Lampiran B', 'Sample Bahan', '2019-03-16', 'C00011', 1, 'SUP2', 'Jakarta Barat', 5, 'Keterangan', 'Sample Bahan Baku', 4, NULL, 0, 'Zat Aktif', 'BATCH 1', '2019-03-16', '2019-03-16', 'No Reg 2019/dsa', 'Kemasan 01', 100, '30', 'No Subject', '2019-03-21', '2019-03-29', 'Joko Santosa', 0, 1, 2, '2019-03-16 13:34:18', 'N14615', '', 'N14615', '2019-03-16 13:34:03', 'N14615', '2019-03-31 15:45:53');
...
INSERT INTO `mt02` (`iMt02`, `iMt01`, `dTgl_Kontrak`, `p1_nama`, `p1_jabatan`, `p1_perusahaan`, `p1_alamat`, `p1_an`, `p2_nama`, `p2_jabatan`, `vNama_sample`, `vAcuan_metode_uji`, `vKeterangan`, `iSubmit`, `iApprove`, `dApprove`, `cApprove`, `vRemark`, `cCreated`, `dCreated`, `cUpdated`, `dUpdated`, `lDeleted`) VALUES
	...
	(3, 5, '2019-03-31', 'Nama dari Dinas', 'Kepala', 'Dinas Oke', 'Okeh', 'An Kepala', 'Nama dari Customer', 'Direksi', 'SUP2', 'Kiriman Dinas', 'Oke', 1, 0, NULL, NULL, NULL, 'A00001', '2019-03-31 16:10:03', NULL, '2019-03-31 16:10:03', 0);
...
-- Membuang data untuk tabel bbpmsoh.mt03: ~0 rows (lebih kurang)
DELETE FROM `mt03`;
/*!40000 ALTER TABLE `mt03` DISABLE KEYS */;
INSERT INTO `mt03` (`iMt03`, `iMt01`, `vnomor_03`, `dtanggal_03`, `iAda_batch`, `iTgl_expired`, `iEtiket_brosur`, `iM_jenis_brosur`, `iReq_permohonan`, `iPengantar_direktorat`, `iHasil_ppoh`, `iBahan_standard`, `tCatatan`, `iSubmit`, `iApprove`, `dApprove`, `cApprove`, `vRemark`, `vCatatan`, `cCreated`, `dCreated`, `cUpdated`, `dUpdated`, `lDeleted`) VALUES
	(1, 2, 'Oke000', '2019-03-13', 0, 1, NULL, 2, 0, 1, 1, 0, 'OKE LOOO999', 1, 2, '2019-03-17 10:31:52', 'N14615', 'llll', NULL, 'N14615', '2019-03-17 00:21:20', 'N14615', '2019-03-17 10:31:52', 0);
...
-- Membuang data untuk tabel bbpmsoh.mt05: ~0 rows (lebih kurang)
DELETE FROM `mt05`;
...
-- Membuang data untuk tabel bbpmsoh.mt05_detail: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel bbpmsoh.mt07: ~0 rows (lebih kurang)
DELETE FROM `mt07`;
/*!40000 ALTER TABLE `mt07` DISABLE KEYS */;
INSERT INTO `mt07` (`iMt07`, `iMt01`, `vKepada_yth`, `dTanggal`, `iSubmit`, `iApprove_unit_uji`, `dApprove_unit_uji`, `cApprove_unit_uji`, `vRemark_unit_uji`, `iApprove_uji`, `dApprove_uji`, `cApprove_uji`, `vRemark_uji`, `cCreated`, `dCreated`, `cUpdated`, `dUpdated`, `lDeleted`) VALUES
	(1, 2, 'PT SANA SINI', '2019-03-26', 1, 2, '2019-03-17 18:22:17', 'N14615', 'app', 0, NULL, NULL, NULL, 'N14615', '2019-03-17 18:03:15', 'N14615', '2019-03-17 18:22:17', 0);
...
-- Membuang data untuk tabel bbpmsoh.m_tujuan_pengujian: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel bbpmsoh.sysparam: ~0 rows (lebih kurang)
