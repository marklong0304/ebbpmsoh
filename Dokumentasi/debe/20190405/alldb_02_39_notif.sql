...
-- Dumping data for table bbpmsoh.mt01: ~9 rows (approximately)
DELETE FROM `mt01`;
...
INSERT INTO `mt08a` (`iMt8a`, `vNama_sample`, `iMt01`, `iSubmit`, `iKesimpulan`, `iApprove_unit_uji`, `dApprove`, `cApprove`, `vRemark`, `cCreated`, `iApprove_qa`, `dApprove_qa`, `cApprove_qa`, `vRemark_qa`, `dCreated`, `cUpdated`, `dUpdated`, `lDeleted`) VALUES
	(6, '0', 2, 1, '2', 2, '2019-04-02 02:55:24', 'A00003', 'oke approve', 'A00003', 2, '2019-04-03 09:17:48', 'A00032', 'approve qa', '2019-04-02 01:30:46', 'A00032', '2019-04-03 09:17:48', 0);
...
-- Dumping data for table bbpmsoh.mt08b: ~1 rows (approximately)
DELETE FROM `mt08b`;
...
INSERT INTO `mt08b` (`iMt8b`, `vNama_sample`, `iMt01`, `iSubmit`, `iKesimpulan`, `iApprove_unit_uji`, `dApprove`, `cApprove`, `vRemark`, `iApprove_qa`, `dApprove_qa`, `cApprove_qa`, `vRemark_qa`, `cCreated`, `dCreated`, `cUpdated`, `dUpdated`, `lDeleted`) VALUES
	(8, '0', 2, 1, '2', 2, '2019-04-02 04:35:04', 'A00002', 'mt8b', 2, '2019-04-03 09:22:35', 'A00032', 'oke qa', 'A00002', '2019-04-02 04:34:25', 'A00032', '2019-04-03 09:22:35', 0);
...
-- Dumping data for table bbpmsoh.mt08b_fisik: ~0 rows (approximately)
...
-- Dumping data for table bbpmsoh.mt09: ~1 rows (approximately)
DELETE FROM `mt09`;
...
INSERT INTO `mt09` (`iMt09`, `vNama_sample`, `iMt01`, `iSubmit`, `vKomposisi`, `iKesimpulan`, `iKesimpulan_khusus`, `iApprove_unit_uji`, `dApprove`, `cApprove`, `vRemark`, `iApprove_qa`, `dApprove_qa`, `cApprove_qa`, `vRemark_qa`, `cCreated`, `dCreated`, `cUpdated`, `dUpdated`, `lDeleted`) VALUES
	(8, '0', 2, 1, 'xxx', '2', '2', 0, NULL, NULL, NULL, 1, '2019-04-03 09:25:00', 'A00032', 'ubah lagi', 'A00004', '2019-04-02 06:43:32', 'A00004', '2019-04-03 09:28:22', 0);
...
-- Dumping data for table bbpmsoh.mt09_fisik: ~0 rows (approximately)
...
-- Dumping data for table bbpmsoh.sysparam: ~5 rows (approximately)
...
-- Dumping data for table erp_privi.privi_actilog: ~2 rows (approximately)
...
INSERT INTO `privi_actilog` (`id`, `tStart`, `tEnd`, `cNip`, `cModule`, `iCounter`, `cIp`) VALUES
	(1, '2019-04-05 01:53:06', NULL, 'N14615', 'Privilege2/priv2/setup/application', 1, '127.0.0.1'),
	(2, '2019-04-05 01:54:45', NULL, 'N14615', 'umum/master_employee', 1, '127.0.0.1'),
	(3, '2019-04-05 01:56:33', NULL, 'N14615', 'umum/master_customer', 1, '127.0.0.1'),
	...
	(8, '2019-04-05 02:21:28', NULL, 'C00011', 'pengujian/mt01', 3, '127.0.0.1'),
	(9, '2019-04-05 02:30:49', NULL, 'C00011', 'schedulercheck/inbox_erp_core', 2, '127.0.0.1'),
	(10, '2019-04-05 02:34:29', NULL, 'A00001', 'schedulercheck/inbox_erp_core', 5, '::1'),
...
) ENGINE=MyISAM AUTO_INCREMENT=20959 DEFAULT CHARSET=latin1 COMMENT='Isi list authorisasi untuk setiap user';

-- Dumping data for table erp_privi.privi_authlist: 16 rows
...
INSERT INTO `privi_group_pt_app_mod` (`id`, `iCompanyId`, `idprivi_apps`, `idprivi_group`, `idprivi_modules`, `iCrud`, `className`, `tCreatedAt`, `cCreatedBy`, `tUpdatedAt`, `cUpdatedBy`, `isDeleted`) VALUES
	...
	(9988, 3, 130, 282, 4267, 0, '0', '2019-01-27 00:57:54', 'N14615', '2019-01-27 00:57:54', '-', 0),
	(9989, 3, 130, 282, 4268, 13, '0', '2019-01-27 00:57:54', 'N14615', '2019-01-27 00:57:54', '-', 0),
	(9990, 3, 130, 282, 4269, 0, '0', '2019-01-27 00:57:54', 'N14615', '2019-01-27 00:57:54', '-', 0),
	(9991, 3, 130, 282, 4271, 0, '0', '2019-01-27 00:57:54', 'N14615', '2019-01-27 00:57:54', '-', 0),
	(9992, 3, 130, 282, 4259, 4, '0', '2019-01-27 00:57:54', 'N14615', '2019-01-27 00:57:54', '-', 0),
	...
	(10004, 3, 130, 283, 4267, 13, '0', '2019-01-27 01:01:30', 'N14615', '2019-01-27 01:01:30', '-', 0),
	(10005, 3, 130, 283, 4268, 0, '0', '2019-01-27 01:01:30', 'N14615', '2019-01-27 01:01:30', '-', 0),
	(10006, 3, 130, 283, 4269, 0, '0', '2019-01-27 01:01:30', 'N14615', '2019-01-27 01:01:30', '-', 0),
	(10007, 3, 130, 283, 4271, 0, '0', '2019-01-27 01:01:30', 'N14615', '2019-01-27 01:01:30', '-', 0),
	(10008, 3, 130, 283, 4259, 4, '0', '2019-01-27 01:01:30', 'N14615', '2019-01-27 01:01:30', '-', 0),
...
) ENGINE=MyISAM AUTO_INCREMENT=232 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='Contain with session historical after login succeed ';

-- Dumping data for table erp_privi.privi_session_log: 15 rows
...
INSERT INTO `privi_session_log` (`idprivi_session_hist`, `cNip`, `iCompanyId`, `vSessionID`, `dLoginAt`, `dLogoutAt`, `vIPSource`, `tUpdatedAt`, `cUpdatedBy`) VALUES
	(217, 'N14615', 3, 'cn81auv6i5aktf3g0ffd5fii36', '2019-04-05 00:31:10', '0000-00-00 00:00:00', '::1', NULL, NULL),
	(218, 'N14616', 3, 'popjijkdeg2mmdn6thghob2qo2', '2019-01-26 13:40:33', '2019-01-26 13:40:33', '127.0.0.1', NULL, NULL),
	(219, 'A00001', 3, '6rnfpi0a9nfkmmg2jvbgqobn14', '2019-04-05 01:55:52', '0000-00-00 00:00:00', '::1', NULL, NULL),
	(220, 'C00001', 3, '1fndh8pa61hdqg427lfm7vei95', '2019-02-03 22:10:22', '2019-02-03 22:10:22', '127.0.0.1', NULL, NULL),
	(221, 'A00002', 3, 'bahik41s241bmhd70c8ua8nt95', '2019-04-02 06:39:29', '2019-04-02 06:39:29', '127.0.0.1', NULL, NULL),
	(222, 'A00003', 3, 'g7akk2map8lsbkmjjqliovnee4', '2019-04-02 03:32:50', '2019-04-02 03:32:50', '127.0.0.1', NULL, NULL),
	(223, 'A00004', 3, '0rc3tcsffqib0j4gphesoo3ct7', '2019-04-03 09:28:26', '2019-04-03 09:28:26', '127.0.0.1', NULL, NULL),
	...
	(231, 'A00032', 3, '8h32cu767mokgmlv8tkhthiqi1', '2019-04-03 09:28:35', '0000-00-00 00:00:00', '127.0.0.1', NULL, NULL);
...
-- Dumping data for table gps_msg.erp_inbox: ~7 rows (approximately)
...
INSERT INTO `erp_inbox` (`inbox_id`, `send_count`, `company_id`, `modul_id`, `group_id`, `cnip_sender`, `vsubject`, `tmessage`, `vto`, `vcc`, `dcreate`, `ccreate`, `dupdate`, `cupdate`, `ldeleted`) VALUES
	...
	(20, 0, 0, 4260, 0, 'C00011', 'e-Pengujian -> New MT01 R00006', '\r\n                        <p>Diberitahukan bahwa ada Permintaan Permohonan Kontrak Pengujian Mutu Obat Hewan baru yang membutuhkan Follow up, dengan rincian sebagai berikut : <p>\r\n                        <br><br>  \r\n                        <table border=\'1\' style=\'width: 750px;border-collapse: collapse;\'>\r\n                            <tr>\r\n                                    <td style=\'width: 30%;\'><b>Nomor Transaksi</b></td>\r\n                                    <td> : R00006</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td style=\'width: 30%;\'><b>Nama Pemohon</b></td>\r\n                                    <td> : C00011 || Cakra</td>\r\n                            </tr>\r\n\r\n\r\n                            <tr>\r\n                                    <td><b>No Permintaan</b></td>\r\n                                    <td> : Nomor 1 Message</td>\r\n                            </tr> \r\n                            <tr>\r\n                                    <td><b>Perihal</b></td>\r\n                                    <td> :Nomor 1 Message</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Nama Perusahaan</b></td>\r\n                                    <td> :PT. HaHa</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Alamat</b></td>\r\n                                    <td> : Jakarta</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Nama Produsen</b></td>\r\n                                    <td> :Produses</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Alamat Produsen</b></td>\r\n                                    <td> : Alamat produsennya</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Tujuan Pengujian Mutu</b></td>\r\n                                    <td> :Daftar Baru</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Nama Sample</b></td>\r\n                                    <td> :Sample Okeh</td>\r\n                            </tr>  \r\n\r\n\r\n                            <tr>\r\n                                    <td><b>Lokasi Modul</b></td>\r\n                                    <td> e-Pengujian -> Transaksi -> MT01</td>\r\n                            </tr>\r\n\r\n                            \r\n                            \r\n                        </table> \r\n\r\n                    <br/> <br/>\r\n                    Demikian, mohon segera follow up  pada aplikasi e-Pengujian. Terimakasih.<br><br><br>\r\n                    Post Master', '0,', 'C00011,select a.idprivi_group,a.vNamaGroup,c.cNIP \r\nfrom erp_privi.privi_group_pt_app a \r\njoin erp_privi.privi_apps b on b.idprivi_apps=a.idprivi_apps\r\njoin erp_privi.privi_authlist c on c.idprivi_apps=b.idprivi_apps and c.idprivi_group=a.iID_GroupApp\r\nwh', '2019-04-05 02:24:28', 'C00011', NULL, NULL, 0),
	(21, 0, 0, 4260, 0, 'C00011', 'e-Pengujian -> New MT01 R00006', '\r\n                        <p>Diberitahukan bahwa ada Permintaan Permohonan Kontrak Pengujian Mutu Obat Hewan baru yang membutuhkan Follow up, dengan rincian sebagai berikut : <p>\r\n                        <br><br>  \r\n                        <table border=\'1\' style=\'width: 750px;border-collapse: collapse;\'>\r\n                            <tr>\r\n                                    <td style=\'width: 30%;\'><b>Nomor Transaksi</b></td>\r\n                                    <td> : R00006</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td style=\'width: 30%;\'><b>Nama Pemohon</b></td>\r\n                                    <td> : C00011 || Cakra</td>\r\n                            </tr>\r\n\r\n\r\n                            <tr>\r\n                                    <td><b>No Permintaan</b></td>\r\n                                    <td> : Nomor 1 Message</td>\r\n                            </tr> \r\n                            <tr>\r\n                                    <td><b>Perihal</b></td>\r\n                                    <td> :Nomor 1 Message</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Nama Perusahaan</b></td>\r\n                                    <td> :PT. HaHa</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Alamat</b></td>\r\n                                    <td> : Jakarta</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Nama Produsen</b></td>\r\n                                    <td> :Produses</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Alamat Produsen</b></td>\r\n                                    <td> : Alamat produsennya</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Tujuan Pengujian Mutu</b></td>\r\n                                    <td> :Daftar Baru</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Nama Sample</b></td>\r\n                                    <td> :Sample Okeh</td>\r\n                            </tr>  \r\n\r\n\r\n                            <tr>\r\n                                    <td><b>Lokasi Modul</b></td>\r\n                                    <td> e-Pengujian -> Transaksi -> MT01</td>\r\n                            </tr>\r\n\r\n                            \r\n                            \r\n                        </table> \r\n\r\n                    <br/> <br/>\r\n                    Demikian, mohon segera follow up  pada aplikasi e-Pengujian. Terimakasih.<br><br><br>\r\n                    Post Master', '0,', 'C00011,select a.idprivi_group,a.vNamaGroup,c.cNIP \r\nfrom erp_privi.privi_group_pt_app a \r\njoin erp_privi.privi_apps b on b.idprivi_apps=a.idprivi_apps\r\njoin erp_privi.privi_authlist c on c.idprivi_apps=b.idprivi_apps and c.idprivi_group=a.iID_GroupApp\r\nwh', '2019-04-05 02:26:50', 'C00011', NULL, NULL, 0),
	(22, 0, 0, 4260, 0, 'C00011', 'e-Pengujian -> New MT01 R00006', '\r\n                        <p>Diberitahukan bahwa ada Permintaan Permohonan Kontrak Pengujian Mutu Obat Hewan baru yang membutuhkan Follow up, dengan rincian sebagai berikut : <p>\r\n                        <br><br>  \r\n                        <table border=\'1\' style=\'width: 750px;border-collapse: collapse;\'>\r\n                            <tr>\r\n                                    <td style=\'width: 30%;\'><b>Nomor Transaksi</b></td>\r\n                                    <td> : R00006</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td style=\'width: 30%;\'><b>Nama Pemohon</b></td>\r\n                                    <td> : C00011 || Cakra</td>\r\n                            </tr>\r\n\r\n\r\n                            <tr>\r\n                                    <td><b>No Permintaan</b></td>\r\n                                    <td> : Nomor 1 Message</td>\r\n                            </tr> \r\n                            <tr>\r\n                                    <td><b>Perihal</b></td>\r\n                                    <td> :Nomor 1 Message</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Nama Perusahaan</b></td>\r\n                                    <td> :PT. HaHa</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Alamat</b></td>\r\n                                    <td> : Jakarta</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Nama Produsen</b></td>\r\n                                    <td> :Produses</td>\r\n                            </tr> \r\n\r\n                            <tr>\r\n                                    <td><b>Alamat Produsen</b></td>\r\n                                    <td> : Alamat produsennya</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Tujuan Pengujian Mutu</b></td>\r\n                                    <td> :Daftar Baru</td>\r\n                            </tr>\r\n\r\n                            <tr>\r\n                                    <td><b>Nama Sample</b></td>\r\n                                    <td> :Sample Okeh</td>\r\n                            </tr>  \r\n\r\n\r\n                            <tr>\r\n                                    <td><b>Lokasi Modul</b></td>\r\n                                    <td> e-Pengujian -> Transaksi -> MT01</td>\r\n                            </tr>\r\n\r\n                            \r\n                            \r\n                        </table> \r\n\r\n                    <br/> <br/>\r\n                    Demikian, mohon segera follow up  pada aplikasi e-Pengujian. Terimakasih.<br><br><br>\r\n                    Post Master', '0,', 'C00011,select a.idprivi_group,a.vNamaGroup,c.cNIP \r\nfrom erp_privi.privi_group_pt_app a \r\njoin erp_privi.privi_apps b on b.idprivi_apps=a.idprivi_apps\r\njoin erp_privi.privi_authlist c on c.idprivi_apps=b.idprivi_apps and c.idprivi_group=a.iID_GroupApp\r\nwh', '2019-04-05 02:28:21', 'C00011', NULL, NULL, 0),
...
-- Dumping data for table gps_msg.erp_inbox_details: ~36 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  KEY `cNipx` (`cNip`),
  KEY `iDivisionID` (`iDivisionID`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=latin1 CHECKSUM=1 ROW_FORMAT=DYNAMIC COMMENT='master informasi pegawai';

-- Dumping data for table hrd.employee: ~18 rows (approximately)
DELETE FROM `employee`;
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
...
-- Dumping data for table hrd.msdepartement: ~9 rows (approximately)
...
-- Dumping data for table hrd.msdivision: ~7 rows (approximately)
...
-- Dumping data for table hrd.position: ~9 rows (approximately)
