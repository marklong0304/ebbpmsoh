...
-- Dumping data for table erp_privi.privi_actilog: ~176 rows (approximately)
...
REPLACE INTO `privi_session_log` (`idprivi_session_hist`, `cNip`, `iCompanyId`, `vSessionID`, `dLoginAt`, `dLogoutAt`, `vIPSource`, `tUpdatedAt`, `cUpdatedBy`) VALUES
	...
	(219, 'A00001', 3, 'g568gpvo8vnut8lb805bpapho7', '2019-04-21 18:31:32', '0000-00-00 00:00:00', '127.0.0.1', NULL, NULL),
