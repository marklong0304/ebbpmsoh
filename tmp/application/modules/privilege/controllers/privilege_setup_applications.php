...
class Privilege_Setup_Applications extends MX_Controller {
	...
	public function __construct() {
		...
		//
		$this->url 	   = 'privilege/privilege_setup_applications';
		$this->view    = 'privilege/privilege_setup_applications/v_applications';
		$this->sort_by = 'vAppName';
		$this->caption = 'Application';
	}
	...
	public function processForm() {
		...
		$optionsDtl = array(
				...
				array(
						'title'=>'Modules',
						'isi'=>'<iframe id="groups" src="'.base_url().'privilege/privilege_setup_modules/output?group_id='.$_GET['group_id'].'&modul_id='.$_GET['modul_id'].'&company_id='.$_GET['company_id'].'&parent_id='.$_GET['id'].'&urut=0&idprivi_apps='.$row['idprivi_apps'].'" scrolling="auto" height="400" width="100%">
								</iframe>'//$modules
				) 
		);
