...
class Personalia_Master_Propinsi extends MX_Controller {
	...
	public function __construct() {
		...
		$this->table  = 'provinsi';
		$this->model  = 'm_propinsi';
		$this->method = 'getAllPropinsi';
		$this->pk_id  = 'iprovid';
		
		//
		$this->url 	  = 'personalia/personalia_master_propinsi';
		$this->view   = 'personalia/personalia_master_propinsi/v_propinsi';
		$this->sort_by= 'vName';
		$this->caption= 'Propinsi List';
	...
	public function output(){
		...
		$property		 = array('data'        => $this->data 
								...
								, 'where_condition' => $this->db_prefix.'.provinsi.lDeleted = "0"'		
							);
