...
class Personalia_Master_Bank extends MX_Controller {
	...
	public function __construct() {
		...
		$this->table  = 'bank';
		$this->model  = 'm_bank';
		$this->method = 'getAllBank';
		$this->pk_id  = 'iBankID';
		
		//
		$this->url 	  = 'personalia/personalia_master_bank';
		$this->view   = 'personalia/personalia_master_bank/v_bank';
		$this->sort_by= 'vName';
		$this->caption= 'Bank List';
	...
	public function output(){
		...
		$property		 = array('data'        => $this->data 
								...
								, 'where_condition' => $this->db_prefix.'.bank.lDeleted = "0"'		
							);
