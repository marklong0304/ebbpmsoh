...
class Personalia_Master_Area extends MX_Controller {
	...
	public function __construct() {
		...
		//
		$this->url 	  = 'personalia/personalia_master_area';
		$this->view   = 'personalia/personalia_master_area/v_area';
		$this->sort_by= 'vAreaName';
		$this->caption= 'Area List';
	...
	public function output(){
		...
		$property		 = array('data'        => $this->data 
								...
								, 'where_condition' => $this->db_prefix.'.area.lDeleted = "0"'		
							);
	...
	public function processForm() {
		...
		$data = array(
				...
				array(
						...
						'width'  => 220,
						'size'   => 30,
						'values' => $this->m_propinsi->getAllPropinsi(),
						'value'  => $row['iKdPropinsi'],
						'maxlength' => 50,
						'type'   => 'combobox',
						'style'  => '',
						'class'  	=> 'fieldTextBox',
