...
$db['complain']['hostname'] = $host;
$db['complain']['username'] = 'nplnet';
$db['complain']['password'] = 'nplnet01';
$db['complain']['database'] = 'complain';
$db['complain']['dbdriver'] = 'mysql';
$db['complain']['dbprefix'] = '';
$db['complain']['pconnect'] = TRUE;
$db['complain']['db_debug'] = TRUE;
$db['complain']['cache_on'] = FALSE;
$db['complain']['cachedir'] = '';
$db['complain']['char_set'] = 'utf8';
$db['complain']['dbcollat'] = 'utf8_general_ci';
$db['complain']['swap_pre'] = '';
$db['complain']['autoinit'] = TRUE;
$db['complain']['stricton'] = FALSE;
...
$db['brosur']['username'] = 'nplnet';
$db['brosur']['password'] = 'nplnet01';
