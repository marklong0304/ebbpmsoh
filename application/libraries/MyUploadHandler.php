...
class MyUploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
    	  $this->options = array(
            ...
            'param_name' => 'files',
    	  		//CUSTOM
    	  		'folder_aplikasi' =>$options['app_folder'],
    	  		'folder_modul' =>$options['mod_folder'],
    	  		'folder_uniqid' =>$options['id_folder'],
    	  		//CUSTOM
    ...
    protected function get_user_id() {
        $folder_unik = $this->options['folder_aplikasi'].'/'.$this->options['folder_modul'].'/'.$this->options['folder_uniqid'];
        //@session_start();
        //return session_id();
		return $folder_unik;
    }
