<?php
    ...
    $appList = array(
        ...
        'plc0'=> array('erp_plc0',"$J0rP)57BzG|<p+p",'plc2'),
        'plcotc'=> array('erp_plcotc',"L!0\%79X#p2&5b/;",'plc2'),
        'schedulercheck'=> array('erp_schedulercheck',"H?zdwDb[kU1z%};)",'hrd'),
        ...
        'reformulasi'=> array('erp_reformulasi',"7|I,//1mAJ@M^.`e",'reformulasi'),
