...
<head>
	...
	<title>	Event C2Fit | www.c2fit.co.id
</title>
...
<script type="text/javascript" src="../assets/c2pw/assets/js/fresco.js"></script>
<link href="../assets/c2pw/assets/css/fresco/fresco.css" rel="stylesheet" type="text/css" media="screen" />
<!-- CONTENT -->
<div id="contentDiv">
								...
								$format = date('d-m-Y | H:i:s', strtotime($date ));				
									if (!$row->vImageUtama == '') {
							    		...
							    		<div align="center" class="boxc2ft">				
								    		<img class="imgProdukc2fit" src="../'. $row->vImageUtama . '" />
										</div>';
									}
							    	else {
							    		echo '<a href="#">
											<img src="<?php echo base_url(); ?>assets/c2pw/assets/images/no-image-c2fit.jpg" class="width100">		
										</a>';
									}	
										echo '
										<div>
			...
			<div>
				<?php
							...
							{						
								while ($row = $result->fetch_object())
								{
									...
									$format = date('d-m-Y | H:i:s', strtotime($date ));					
										if (!$row->vImages == '') {												    		
											echo '
											<div class="box_listArtkelFull">
							<div class="uiScaledImageContainer hoperMenu">
								<a href="../'. $row->vImages . '">
						        	<img src="../'. $row->vImages . '"  class="imgListArtklFullEvent"/>
						      	</a>
								<div class="textbox">
									<a href="../'. $row->vImages . '" class="fresco"	data-fresco-group="events" data-fresco-caption="Photo Selfie Contest 2016">
										<p class="text">Perbesar Foto</p>	
									</a>										
								</div>
							</div>
						</div>
								    		...
								    		echo '<a href="#">
												<img src="<?php echo base_url(); ?>assets/c2pw/assets/images/no-image-thromecon.jpg" class="width100">		
											</a>';
										}	
								}
					...
					<div class="boxBTN23" align="center">
						<a href="#" target="_blank"class="linkArtFull">More Photos ... </a>
						<br />
					</div>
					...
					<div>
						<br />
						<span class="datePost">
							( &copy; 2016 | Customer Health Care - PT. Novell Pharmaceutical Labs. )
						</span>	
						<h3>Bagikan ke : </h3>
						<div class="component">
					        <a href="javascript: void(0)" onclick="popup_sosmed('http://www.facebook.com/sharer.php?u=http://www.c2fit.co.id/event-6-Event-03')"  class="icon icon-slide facebook">facebook</a>
					        <a href="javascript: void(0)" onclick="popup_sosmed('https://twitter.com/share')" class="icon icon-slide twitter">twitter</a>
					        <a href="javascript: void(0)" onclick="popup_sosmed('https://plus.google.com/share?url=http://www.c2fit.co.id/event-6-Event-03')" class="icon icon-slide googleplus">google+</a>
					    </div>
					</div>
				</div>								
			</div>	
