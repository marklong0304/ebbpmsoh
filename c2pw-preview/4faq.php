						...
						<div class="container" class="absolute">
							<div class="" role="listbox">
								<div class="item active">
									...
									?>
									<img src="../assets/c2pw/assets/images/nwb/bg_kontak_nwb.png" width="100%" class="kontakdisp">
									<img src="../assets/c2pw/assets/images/nwb/bg_kontak_nwb_mobile.png" width="100%" class="kontakdispmobil">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="content">
							<div style="padding: 0px; border: 0px solid #CCCCCC;">
								<h3 style="">
										Jika anda ingin bertanya, silahkan isi form dibawah ini :
								</h3>
								<div class="clear"></div>
								<form method="post" action="/addtestimoni" enctype="multipart/form-data">
									{{ csrf_field() }} 
									<div class="form-group">
										Nama : <br>
										<input class="" type="text" /> <br>
										Email : <br>
										<input class="" type="email" /> <br>
										Pesan Anda : <br>
										<textarea rows="5" name="iKomentar" id="iKomentar" style="width: 100%;"  placeholder="Testimoni Anda"></textarea> 
									</div>
									
									<div class="control-group-btn">
									  <div class="" align="left">
										<input type="submit" value="Kirim Testimoni" class="btn btn-login flat form-footer" />  
									  </div>                    
									</div> 
								</form>
							</div>
						<script type="text/javascript">
							var el = document.getElementById("menuKeluhan");
