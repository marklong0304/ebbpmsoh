...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title> Produk fitamino | www.fitamino.co.id </title>
		<meta name="keywords" 				   content="Produk fitamino | Suplemen Kesehatan">
		<meta property="og:url"                content="" />
		<meta property="og:type"               content="Produk" />
		<meta property="og:title"              content="Produk fitamino | www.fitamino.co.id" />
		<meta property="og:description"        content="Produk fitamino | Suplemen Kesehatan" />
		<meta property="og:image"              content="../assets/c2pw/fitamino/images/fitamino//bg_produk_fitamino.jpg" />
	...
	<body id="top">
				...
				if ($result = $mysqli -> query("SELECT * FROM manufacturing.product_brand where cGroup2 ='$cGroup2' ")) {
					...
					if ($result -> num_rows > 0) {
						while ($row = $result -> fetch_object()) {
							...
							echo '<img src="' . $fotonya . '" alt="" title="" width="100%" />';
			...
			<div class="divwrap">
				<div class="divcontent">
					...
					<ul class="icons" style="margin-left: 15px;">
						...
						<li>
							<a href="javascript: void(0)" onclick="popup_sosmed('http://www.facebook.com/sharer.php?u=http://www.fitamino.co.id/produk')"   class="icon fa-facebook"><span class="label">Facebook</span></a>
						</li>
					</ul>
					<br />
					<div class="clear"></div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('#menuProduk').addClass('button special');
			});
		</script>
