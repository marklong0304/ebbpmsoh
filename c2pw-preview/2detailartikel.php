...
<head>
	...
	<title>	Artikel C2Fit | www.c2fit.co.id
</title>
	...
	<div class="fullContent pagesDetcontent">		
		...
		<div class="boxCT">
			<div class="diVisiCOntent">
										...
										// display records if there are records to display
											...
											{						
												while ($row = $result->fetch_object())
												{
													echo '
													<div class="datePost">
															'.$row->created_at.' - oleh : '.$row->iCreated.'
														</div>
				...
				<div class="sidebarConttn">	
					<div class="headArticle">
						<h3>ARTIKEL / NEWS</h3>
					</div>
					<div class="isiListArt">										
						<div>
							<?php
									 ...
									 if ($result = $mysqli->query("SELECT * FROM artikel where eType ='ARTIKEL' And ldeleted = '0' And cGroup2='$idgroup' ORDER BY created_at DESC limit 5 "  )) {
										// display records if there are records to display
											...
											{						
												...
												{
													echo '
													<div class="box_listArtkel">
														<div class="kotak_art" style="">
																						    		<a href="#">
																	<img class="imgListArtkl" src="../' . $row->vImages . '">		
																</a>
						...
						<div class="boxBTN23" align="center">
							<br />
							<a href="http://www.c2fit.co.id/artikel" class="linkArtFull">Artikel Lainnya</a>
						</div>
						<div class="clear"></div>
					</div>	
