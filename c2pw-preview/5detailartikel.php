...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title> 10 Komposisi Nutrafor White Beauty dan Manfaatnya Bro </title>
		<meta name="keyword" 				   content="Fitamino | Suplemen Kesehatan, " />
		<meta property="og:url"                content="" />
		<meta property="og:type"               content="article" />
		<meta property="og:title"              content="10 Komposisi Nutrafor White Beauty dan Manfaatnya Bro" />
		<meta property="og:description"        content="" />
		<meta property="og:image"              content="../assets/c2pw/artikel/files/smsc/website/artikel/31/10manfaat.jpg" />
			...
			<div class="divwrap">
				<div class="divcontent">
					<section>
						...
						if ($result = $mysqli -> query("SELECT * FROM artikel where iArtikelid ='$id' And cGroup2 ='$cGroup2' ")) {
...
<div class="datePost">' . $format . ' - oleh :' . $row -> vEditor . '</div>
...
';
						...
						<div class="datePost">
							( &copy; 2018 | Customer Health Care - PT. Novell Pharmaceutical Labs. )
						</div>
						<br />
						<div class="clear"></div>
					...
					<ul class="icons">
						...
						<li>
							<a href="javascript: void(0)" onclick="popup_sosmed('http://www.facebook.com/sharer.php?u=http://www.fitamino.co.id/artikel-31-10-Komposisi-Nutrafor-White-Beauty-dan-Manfaatnya-Bro')"  class="icon fa-facebook"><span class="label">Facebook</span></a>
						</li>
					</ul>
				...
				<div class="divright">
					<div class="special">
						<h3 style="font-weight: normal;">Artikel lain</h3>
						<?php $id = $_GET['id'];
						$cGroup2 = $_GET['cGroup2'];
						if ($result = $mysqli -> query("SELECT * FROM artikel where eType='ARTIKEL' And ldeleted = '0' and cGroup2 ='$cGroup2'  ORDER BY RAND() limit 5")) {
							// display records if there are records to display
							if ($result -> num_rows > 0) {
								while ($row = $result -> fetch_object()) {
									if (!file_exists('../' . $row -> vImages) || $row -> vImages == '') {
