...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title> Testimoni C2Fit | www.c2fit.co.id </title>
		<meta name="keywords" 				   content="C2Fit | Fit Sepanjang Hari">
		<meta property="og:url"                content="" />
		<meta property="og:type"               content="Testimoni" />
		<meta property="og:title"              content="Testimoni C2Fit | www.c2fit.co.id" />
		<meta property="og:description"        content="" />
		<meta property="og:image"              content="../assets/c2pw/images/cp2.png" />
	...
	<body id="top">
		...
		<div class="wrapper">
			<div class="divwrap">
				...
				<div class="divcontent">
					<h2 class="judulHed">Untuk memberikan testimoni anda harus login terlebih dahulu</h2><a href="#login" target="_blank"class="button ">Login disini !</a>
					<div>
						<div class="boxBTN23">
							<br>
						</div>
					...
					<?php
							 ...
							 if ($result = $mysqli->query("SELECT * FROM testimoni a 
									...
									where a.ePublish ='PUBLISH' and iCreatemember='$id' and a.cGroup2 ='$cGroup2' ORDER BY a.tCreated DESC limit 5" )) {
								// display records if there are records to display
									if ($result->num_rows > 0)
									{
										...
										{											
											...
											if ($row->ifoto == ''){
												$fotonya23 = '../assets/c2pw/fitamino/images/fitamino/no-image-fitamino.png';									
											} else {											
												$fotonya23 = '../'.$row->ifoto;
											}
											...
											echo '
													...
													<div class="boxlistJudul">
														...
														<div class="NameTesti">
															<div>
																'.$row->vName.'
																<br />
																<span class="datePost">'.$row->vPekerjaan.' </span>
																<br />
															</div>
														</div>
														</p>
												...
												<div class="clear"></div>
												<hr class="boxList" style="padding: 0;" />
					...
					<ul class="icons" style="margin-left: 15px;">
						<li>
							Bagikan :
						</li>
						<li>
						...
						<li>
							<a href="javascript: void(0)" onclick="popup_sosmed('http://www.facebook.com/sharer.php?u=http://www.fitamino.co.id/testimoni')"   class="icon fa-facebook"><span class="label">Facebook</span></a>
						</li>
					</ul>
					<br />
				...
				<div class="divright">
					<img src="../assets/c2pw/fitamino/images/fitamino/nadine.png" width="100%" />
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('#menuTestimoni').addClass('button special');
			});
		</script>
