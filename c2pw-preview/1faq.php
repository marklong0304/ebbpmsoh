...
<html lang="en">
	<head>
		...
		<title> Homepage Thromecon | www.thromecon.co.id </title>
				...
				<div class="fullContent pagesDetcontent">
					<div class="">
						<div class="" align="center">
							<img class="" src="../assets/c2pw/assets/images/hedJudul1.png">
						</div>
						<div class="">
							<?php
								 $id = $_GET['id'];
	...
	<div id="boxLog">
		<div class="bgSignBotom">
			<div class="leftFtr">
				...
				<p>
					Daftarkan email anda dan dapatkan info-info terbaru dari THROMECON, atau kirim kritik dan saran kamu tentang THROMECON
				</p>
			</div>
