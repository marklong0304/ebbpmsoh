...
<head>
	...
	<title>	Homepage C2Fit | www.c2fit.co.id
</title>
...
<div><!-- SLIDESHOW VIDEO -->
	<div class="divSLV">
		...
		<div class="boxVideo">
				 ...
				 if ($result = $mysqli->query("SELECT * FROM artikel where iArtikelid ='$id'")) {
					// display records if there are records to display
						...
						{						
							while ($row = $result->fetch_object())
							{
								echo '<div class="bgVideo">
											<iframe width="100%" height="375" src="'. $row->vYoutube.'" frameborder="0" allowfullscreen></iframe>															
										</div>';
							}
			...
			<div class="LeftVideo">
				<div class="boxImmune" style="">
					<h2>Upgrade Your Immune</h2>
					<p>
						<a href="#">Start Now</a>
					</p>
				</div>
	...
	<div id="pageCT">
		...
		<div id="contentDiv">
			<div class="fullContent">
							...
							{						
								while ($row = $result->fetch_object())
								{
									echo '<div class="divAreaPhoto">
												<img class="width100" src="../' . $row->vImages . '">
											</div>	';
									echo ''. $row->vLengkap.'';
								}
				...
				<div class="clear"></div>	
				<div class="boxCTSlide ">
					<div class="headArticle">
						<h2>Article & News</h2>
					</div>
					<div>							
						<div class="clear"></div>
						<div id="ca-container" class="ca-container   top">
							<div class="ca-wrapper">
								<?php
									 ...
									 if ($result = $mysqli->query("SELECT * FROM artikel where eType ='ARTIKEL' And ldeleted = '0' And cGroup2='$idgroup' ORDER BY created_at DESC limit 6"  )) {
										// display records if there are records to display
											if ($result->num_rows > 0)
											{						
												while ($row = $result->fetch_object())
												{
													echo '
														<div class="ca-item ca-item-1">
															<div class="box_listArtkelFullSlide">
																<div class="kotak_art" style="">
																	<div class="uiScaledImageContainer hoperMenu">
																		...
																		<div class="textbox">
																			<a href="#">
																				<p class="text">Quick View</p>	
																			</a>										
																		</div>
																	</div>
																	<div class="clear"></div>	
																	<div class="boxlistIsi">
																		<div class="JudulListArtkl"> 
																			<a href="#">
																				'.$row->vJudul.'
																			</a>
																		</div>
																		...
																		<div class="boxBTN23" align="center">
																			<br />
																			<a href="#" class="linkArtFull">Lihat Selengkapnya</a>
																		</div>
																	</div>	
																	<div class="clear"></div>																
																</div>
				...
				<div>
					<div class="component" align="center">
						<a href="javascript: void(0)" onclick="popup_sosmed('http://www.facebook.com/sharer.php?u=http://c2fit.co.id')"  class="icon icon-slide facebook">facebook</a>
						<a href="javascript: void(0)" onclick="popup_sosmed('https://twitter.com/share')" class="icon icon-slide twitter">twitter</a>
						<a href="javascript: void(0)" onclick="popup_sosmed('https://plus.google.com/share?url=http://c2fit.co.id')" class="icon icon-slide googleplus">google+</a>
					</div><br />
				</div>				
			</div>
			<div class="clear"></div>	
